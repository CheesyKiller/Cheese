...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_mix_color.oso
...
local	float	___360_cmax	%read{287,788} %write{281,762}
local	float	___360_cmin	%read{287,768} %write{286,767}
local	float	___360_h	%read{317,802} %write{293,801}
local	float	___360_s	%read{294,802} %write{291,773}
local	float	___360_v	%read{321,802} %write{288,769}
local	float	___360_cdelta	%read{291,780} %write{287,768}
local	color	___360_c	%read{303,796} %write{299,780}
local	float	___369_i	%read{385,842} %write{384,818}
local	float	___369_f	%read{386,826} %write{385,819}
local	float	___369_p	%read{398,845} %write{388,822}
local	float	___369_q	%read{401,845} %write{391,825}
local	float	___369_t	%read{398,844} %write{395,829}
local	float	___369_h	%read{380,819} %write{374,817}
local	float	___369_s	%read{377,827} %write{375,809}
local	float	___369_v	%read{379,845} %write{376,810}
local	color	___369_rgb	%read{412,846} %write{379,845}
local	float	___389_tm	%read{22,22} %write{21,21}
local	float	___390_tm	%read{41,88} %write{32,32}
local	color	___390_outcol	%read{34,94} %write{33,93}
local	float	___398_tm	%read{109,131} %write{103,103}
local	color	___398_outcol	%read{108,138} %write{104,137}
local	color	___406_outcol	%read{169,214} %write{168,213}
local	float	___407_tmp	%read{175,183} %write{174,179}
local	float	___411_tmp	%read{190,198} %write{189,194}
local	float	___415_tmp	%read{205,213} %write{204,209}
local	float	___419_tmp	%read{223,270} %write{222,263}
local	float	___419_tm	%read{222,256} %write{218,218}
local	color	___419_outcol	%read{226,271} %write{219,270}
local	color	___432_outcol	%read{326,414} %write{275,413}
local	color	___432_hsv2	%read{322,371} %write{321,321}
local	color	___433_hsv	%read{374,376} %write{370,372}
local	color	___433_tmp	%read{413,413} %write{412,412}
local	float	___434_tm	%read{516,516} %write{418,418}
local	color	___434_outcol	%read{421,561} %write{419,560}
local	color	___434_hsv	%read{466,524} %write{465,520}
local	color	___435_hsv2	%read{517,517} %write{514,514}
local	float	___436_tm	%read{659,659} %write{565,565}
local	color	___436_hsv	%read{658,667} %write{611,663}
local	color	___436_hsv2	%read{660,660} %write{657,657}
local	color	___437_outcol	%read{758,848} %write{707,847}
local	color	___437_hsv2	%read{754,805} %write{753,753}
local	color	___438_hsv	%read{808,810} %write{802,806}
local	color	___438_tmp	%read{847,847} %write{846,846}
local	float	___439_tm	%read{858,858} %write{852,852}
local	color	___439_one	%read{854,859} %write{853,853}
local	color	___439_scr	%read{862,862} %write{857,857}
local	color	___440_outcol	%read{921,921} %write{869,920}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:17
#   float t = (use_clamp) ? clamp(Factor, 0.0, 1.0) : Factor;
	if		use_clamp 4 5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{17} %argrw{"r"}
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 Factor $const2 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		t $tmp1 $const1 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:17
#   float t = (use_clamp) ? clamp(Factor, 0.0, 1.0) : Factor;
	assign		t Factor 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{17} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:19
#   if (blend_type == "mix")
	eq		$tmp2 blend_type $const4 	%line{19} %argrw{"wrr"}
	if		$tmp2 8 8 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:20
#     Result = mix(A, B, t);
	mix		Result A B t 	%line{20} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:21
#   if (blend_type == "add")
	eq		$tmp3 blend_type $const5 	%line{21} %argrw{"wrr"}
	if		$tmp3 13 13 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:22
...
#   return mix(col1, col1 + col2, t);
	add		$tmp4 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{12} %argrw{"wrr"}
	mix		Result A $tmp4 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:23
#   if (blend_type == "multiply")
	eq		$tmp5 blend_type $const7 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{23} %argrw{"wrr"}
	if		$tmp5 18 18 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:24
#     Result = node_mix_mul(t, A, B);
	functioncall	$const8 18 	%line{24} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:17
#   return mix(col1, col1 * col2, t);
	mul		$tmp6 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{17} %argrw{"wrr"}
	mix		Result A $tmp6 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:25
#   if (blend_type == "screen")
	eq		$tmp7 blend_type $const9 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{25} %argrw{"wrr"}
	if		$tmp7 29 29 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:26
#     Result = node_mix_screen(t, A, B);
	functioncall	$const10 29 	%line{26} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:22
#   float tm = 1.0 - t;
	sub		___389_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{22} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:24
#   return color(1.0) - (color(tm) + t * (color(1.0) - col2)) * (color(1.0) - col1);
	assign		$tmp9 ___389_tm 	%line{24} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:27
#   if (blend_type == "overlay")
	eq		$tmp17 blend_type $const12 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{27} %argrw{"wrr"}
	if		$tmp17 95 95 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:28
#     Result = node_mix_overlay(t, A, B);
	functioncall	$const13 95 	%line{28} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:29
#   float tm = 1.0 - t;
	sub		___390_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{29} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:31
#   color outcol = col1;
	assign		___390_outcol A 	%line{31} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:33
#   if (outcol[0] < 0.5) {
	compref		$tmp18 ___390_outcol $const14 	%line{33} %argrw{"wrr"}
	lt		$tmp19 $tmp18 $const15 	%argrw{"wrr"}
	if		$tmp19 44 54 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:34
#     outcol[0] *= tm + 2.0 * t * col2[0];
	compref		$tmp20 ___390_outcol $const14 	%line{34} %argrw{"wrr"}
	mul		$tmp21 $const16 t 	%argrw{"wrr"}
	compref		$tmp22 B $const14 	%argrw{"wrr"}
	mul		$tmp23 $tmp21 $tmp22 	%argrw{"wrr"}
	add		$tmp24 ___390_tm $tmp23 	%argrw{"wrr"}
	mul		$tmp25 $tmp20 $tmp24 	%argrw{"wrr"}
	compassign	___390_outcol $const14 $tmp25 	%argrw{"wrr"}
...
#     outcol[0] = 1.0 - (tm + 2.0 * t * (1.0 - col2[0])) * (1.0 - outcol[0]);
	...
	add		$tmp30 ___390_tm $tmp29 	%argrw{"wrr"}
	compref		$tmp31 ___390_outcol $const14 	%argrw{"wrr"}
	sub		$tmp32 $const2 $tmp31 	%argrw{"wrr"}
	mul		$tmp33 $tmp30 $tmp32 	%argrw{"wrr"}
	sub		$tmp34 $const2 $tmp33 	%argrw{"wrr"}
	compassign	___390_outcol $const14 $tmp34 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:40
#   if (outcol[1] < 0.5) {
	compref		$tmp35 ___390_outcol $const17 	%line{40} %argrw{"wrr"}
	lt		$tmp36 $tmp35 $const15 	%argrw{"wrr"}
	if		$tmp36 64 74 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:41
#     outcol[1] *= tm + 2.0 * t * col2[1];
	compref		$tmp37 ___390_outcol $const17 	%line{41} %argrw{"wrr"}
	mul		$tmp38 $const16 t 	%argrw{"wrr"}
	compref		$tmp39 B $const17 	%argrw{"wrr"}
	mul		$tmp40 $tmp38 $tmp39 	%argrw{"wrr"}
	add		$tmp41 ___390_tm $tmp40 	%argrw{"wrr"}
	mul		$tmp42 $tmp37 $tmp41 	%argrw{"wrr"}
	compassign	___390_outcol $const17 $tmp42 	%argrw{"wrr"}
...
#     outcol[1] = 1.0 - (tm + 2.0 * t * (1.0 - col2[1])) * (1.0 - outcol[1]);
	...
	add		$tmp47 ___390_tm $tmp46 	%argrw{"wrr"}
	compref		$tmp48 ___390_outcol $const17 	%argrw{"wrr"}
	sub		$tmp49 $const2 $tmp48 	%argrw{"wrr"}
	mul		$tmp50 $tmp47 $tmp49 	%argrw{"wrr"}
	sub		$tmp51 $const2 $tmp50 	%argrw{"wrr"}
	compassign	___390_outcol $const17 $tmp51 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:47
#   if (outcol[2] < 0.5) {
	compref		$tmp52 ___390_outcol $const18 	%line{47} %argrw{"wrr"}
	lt		$tmp53 $tmp52 $const15 	%argrw{"wrr"}
	if		$tmp53 84 94 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:48
#     outcol[2] *= tm + 2.0 * t * col2[2];
	compref		$tmp54 ___390_outcol $const18 	%line{48} %argrw{"wrr"}
	mul		$tmp55 $const16 t 	%argrw{"wrr"}
	compref		$tmp56 B $const18 	%argrw{"wrr"}
	mul		$tmp57 $tmp55 $tmp56 	%argrw{"wrr"}
	add		$tmp58 ___390_tm $tmp57 	%argrw{"wrr"}
	mul		$tmp59 $tmp54 $tmp58 	%argrw{"wrr"}
	compassign	___390_outcol $const18 $tmp59 	%argrw{"wrr"}
...
#     outcol[2] = 1.0 - (tm + 2.0 * t * (1.0 - col2[2])) * (1.0 - outcol[2]);
	...
	add		$tmp64 ___390_tm $tmp63 	%argrw{"wrr"}
	compref		$tmp65 ___390_outcol $const18 	%argrw{"wrr"}
	sub		$tmp66 $const2 $tmp65 	%argrw{"wrr"}
	mul		$tmp67 $tmp64 $tmp66 	%argrw{"wrr"}
	sub		$tmp68 $const2 $tmp67 	%argrw{"wrr"}
	compassign	___390_outcol $const18 $tmp68 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:54
#   return outcol;
	assign		Result ___390_outcol 	%line{54} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:29
#   if (blend_type == "subtract")
	eq		$tmp69 blend_type $const19 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{29} %argrw{"wrr"}
	if		$tmp69 100 100 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:30
#     Result = node_mix_sub(t, A, B);
	functioncall	$const20 100 	%line{30} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:59
#   return mix(col1, col1 - col2, t);
	sub		$tmp70 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{59} %argrw{"wrr"}
	mix		Result A $tmp70 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:31
#   if (blend_type == "divide")
	eq		$tmp71 blend_type $const21 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{31} %argrw{"wrr"}
	if		$tmp71 139 139 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:32
#     Result = node_mix_div(t, A, B);
	functioncall	$const22 139 	%line{32} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:64
#   float tm = 1.0 - t;
	sub		___398_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{64} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:66
#   color outcol = col1;
	assign		___398_outcol A 	%line{66} %argrw{"wr"}
...
#     outcol[0] = tm * outcol[0] + t * outcol[0] / col2[0];
	compref		$tmp74 ___398_outcol $const14 	%line{69} %argrw{"wrr"}
	mul		$tmp75 ___398_tm $tmp74 	%argrw{"wrr"}
	compref		$tmp76 ___398_outcol $const14 	%argrw{"wrr"}
	...
	compassign	___398_outcol $const14 $tmp80 	%argrw{"wrr"}
...
#     outcol[1] = tm * outcol[1] + t * outcol[1] / col2[1];
	compref		$tmp83 ___398_outcol $const17 	%line{72} %argrw{"wrr"}
	mul		$tmp84 ___398_tm $tmp83 	%argrw{"wrr"}
	compref		$tmp85 ___398_outcol $const17 	%argrw{"wrr"}
	...
	compassign	___398_outcol $const17 $tmp89 	%argrw{"wrr"}
...
#     outcol[2] = tm * outcol[2] + t * outcol[2] / col2[2];
	compref		$tmp92 ___398_outcol $const18 	%line{75} %argrw{"wrr"}
	mul		$tmp93 ___398_tm $tmp92 	%argrw{"wrr"}
	compref		$tmp94 ___398_outcol $const18 	%argrw{"wrr"}
	...
	compassign	___398_outcol $const18 $tmp98 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:78
#   return outcol;
	assign		Result ___398_outcol 	%line{78} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:33
#   if (blend_type == "difference")
	eq		$tmp99 blend_type $const23 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{33} %argrw{"wrr"}
	if		$tmp99 145 145 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:34
#     Result = node_mix_diff(t, A, B);
	functioncall	$const24 145 	%line{34} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:83
#   return mix(col1, abs(col1 - col2), t);
	sub		$tmp101 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{83} %argrw{"wrr"}
	abs		$tmp100 $tmp101 	%argrw{"wr"}
	mix		Result A $tmp100 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:35
#   if (blend_type == "exclusion")
	eq		$tmp102 blend_type $const25 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{35} %argrw{"wrr"}
	if		$tmp102 155 155 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:36
...
#   return max(mix(col1, col1 + col2 - 2.0 * col1 * col2, t), 0.0);
	add		$tmp104 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{88} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:37
#   if (blend_type == "darken")
	eq		$tmp109 blend_type $const27 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{37} %argrw{"wrr"}
	if		$tmp109 160 160 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:38
#     Result = node_mix_dark(t, A, B);
	functioncall	$const28 160 	%line{38} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:93
#   return mix(col1, min(col1, col2), t);
	min		$tmp110 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{93} %argrw{"wrr"}
	mix		Result A $tmp110 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:39
#   if (blend_type == "lighten")
	eq		$tmp111 blend_type $const29 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{39} %argrw{"wrr"}
	if		$tmp111 165 165 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:40
#     Result = node_mix_light(t, A, B);
	functioncall	$const30 165 	%line{40} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:98
#   return mix(col1, max(col1, col2), t);
	max		$tmp112 A B 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{98} %argrw{"wrr"}
	mix		Result A $tmp112 t 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:41
#   if (blend_type == "dodge")
	eq		$tmp113 blend_type $const31 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{41} %argrw{"wrr"}
	if		$tmp113 215 215 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:42
#     Result = node_mix_dodge(t, A, B);
	functioncall	$const32 215 	%line{42} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:103
#   color outcol = col1;
	assign		___406_outcol A 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{103} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:105
#   if (outcol[0] != 0.0) {
	compref		$tmp114 ___406_outcol $const14 	%line{105} %argrw{"wrr"}
...
#     float tmp = 1.0 - t * col2[0];
	...
	sub		___407_tmp $const2 $tmp117 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:107
#     if (tmp <= 0.0) {
	le		$tmp118 ___407_tmp $const1 	%line{107} %argrw{"wrr"}
	if		$tmp118 178 184 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:108
#       outcol[0] = 1.0;
	compassign	___406_outcol $const14 $const2 	%line{108} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:110
#     else if ((tmp = outcol[0] / tmp) > 1.0) {
	compref		$tmp119 ___406_outcol $const14 	%line{110} %argrw{"wrr"}
	div		___407_tmp $tmp119 ___407_tmp 	%argrw{"wrr"}
	gt		$tmp120 ___407_tmp $const2 	%argrw{"wrr"}
	if		$tmp120 183 184 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:111
#       outcol[0] = 1.0;
	compassign	___406_outcol $const14 $const2 	%line{111} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:114
#       outcol[0] = tmp;
	compassign	___406_outcol $const14 ___407_tmp 	%line{114} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:117
#   if (outcol[1] != 0.0) {
	compref		$tmp121 ___406_outcol $const17 	%line{117} %argrw{"wrr"}
...
#     float tmp = 1.0 - t * col2[1];
	...
	sub		___411_tmp $const2 $tmp124 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:119
#     if (tmp <= 0.0) {
	le		$tmp125 ___411_tmp $const1 	%line{119} %argrw{"wrr"}
	if		$tmp125 193 199 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:120
#       outcol[1] = 1.0;
	compassign	___406_outcol $const17 $const2 	%line{120} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:122
#     else if ((tmp = outcol[1] / tmp) > 1.0) {
	compref		$tmp126 ___406_outcol $const17 	%line{122} %argrw{"wrr"}
	div		___411_tmp $tmp126 ___411_tmp 	%argrw{"wrr"}
	gt		$tmp127 ___411_tmp $const2 	%argrw{"wrr"}
	if		$tmp127 198 199 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:123
#       outcol[1] = 1.0;
	compassign	___406_outcol $const17 $const2 	%line{123} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:126
#       outcol[1] = tmp;
	compassign	___406_outcol $const17 ___411_tmp 	%line{126} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:129
#   if (outcol[2] != 0.0) {
	compref		$tmp128 ___406_outcol $const18 	%line{129} %argrw{"wrr"}
...
#     float tmp = 1.0 - t * col2[2];
	...
	sub		___415_tmp $const2 $tmp131 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:131
#     if (tmp <= 0.0) {
	le		$tmp132 ___415_tmp $const1 	%line{131} %argrw{"wrr"}
	if		$tmp132 208 214 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:132
#       outcol[2] = 1.0;
	compassign	___406_outcol $const18 $const2 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:134
#     else if ((tmp = outcol[2] / tmp) > 1.0) {
	compref		$tmp133 ___406_outcol $const18 	%line{134} %argrw{"wrr"}
	div		___415_tmp $tmp133 ___415_tmp 	%argrw{"wrr"}
	gt		$tmp134 ___415_tmp $const2 	%argrw{"wrr"}
	if		$tmp134 213 214 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:135
#       outcol[2] = 1.0;
	compassign	___406_outcol $const18 $const2 	%line{135} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:138
#       outcol[2] = tmp;
	compassign	___406_outcol $const18 ___415_tmp 	%line{138} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:142
#   return outcol;
	assign		Result ___406_outcol 	%line{142} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:43
#   if (blend_type == "burn")
	eq		$tmp135 blend_type $const33 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{43} %argrw{"wrr"}
	if		$tmp135 272 272 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:44
#     Result = node_mix_burn(t, A, B);
	functioncall	$const34 272 	%line{44} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:147
#   float tmp, tm = 1.0 - t;
	sub		___419_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{147} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:149
#   color outcol = col1;
	assign		___419_outcol A 	%line{149} %argrw{"wr"}
...
#   if (tmp <= 0.0) {
	le		$tmp138 ___419_tmp $const1 	%line{152} %argrw{"wrr"}
	if		$tmp138 226 237 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:153
#     outcol[0] = 0.0;
	compassign	___419_outcol $const14 $const1 	%line{153} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:155
#   else if ((tmp = (1.0 - (1.0 - outcol[0]) / tmp)) < 0.0) {
	compref		$tmp139 ___419_outcol $const14 	%line{155} %argrw{"wrr"}
...
#     outcol[0] = 0.0;
	compassign	___419_outcol $const14 $const1 	%line{156} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:158
#   else if (tmp > 1.0) {
	gt		$tmp143 ___419_tmp $const2 	%line{158} %argrw{"wrr"}
	if		$tmp143 236 237 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:159
#     outcol[0] = 1.0;
	compassign	___419_outcol $const14 $const2 	%line{159} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:162
#     outcol[0] = tmp;
	compassign	___419_outcol $const14 ___419_tmp 	%line{162} %argrw{"wrr"}
...
#   if (tmp <= 0.0) {
	le		$tmp146 ___419_tmp $const1 	%line{166} %argrw{"wrr"}
	if		$tmp146 243 254 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:167
#     outcol[1] = 0.0;
	compassign	___419_outcol $const17 $const1 	%line{167} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:169
#   else if ((tmp = (1.0 - (1.0 - outcol[1]) / tmp)) < 0.0) {
	compref		$tmp147 ___419_outcol $const17 	%line{169} %argrw{"wrr"}
...
#     outcol[1] = 0.0;
	compassign	___419_outcol $const17 $const1 	%line{170} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:172
#   else if (tmp > 1.0) {
	gt		$tmp151 ___419_tmp $const2 	%line{172} %argrw{"wrr"}
	if		$tmp151 253 254 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:173
#     outcol[1] = 1.0;
	compassign	___419_outcol $const17 $const2 	%line{173} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:176
#     outcol[1] = tmp;
	compassign	___419_outcol $const17 ___419_tmp 	%line{176} %argrw{"wrr"}
...
#   if (tmp <= 0.0) {
	le		$tmp154 ___419_tmp $const1 	%line{180} %argrw{"wrr"}
	if		$tmp154 260 271 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:181
#     outcol[2] = 0.0;
	compassign	___419_outcol $const18 $const1 	%line{181} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:183
#   else if ((tmp = (1.0 - (1.0 - outcol[2]) / tmp)) < 0.0) {
	compref		$tmp155 ___419_outcol $const18 	%line{183} %argrw{"wrr"}
...
#     outcol[2] = 0.0;
	compassign	___419_outcol $const18 $const1 	%line{184} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:186
#   else if (tmp > 1.0) {
	gt		$tmp159 ___419_tmp $const2 	%line{186} %argrw{"wrr"}
	if		$tmp159 270 271 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:187
#     outcol[2] = 1.0;
	compassign	___419_outcol $const18 $const2 	%line{187} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:190
#     outcol[2] = tmp;
	compassign	___419_outcol $const18 ___419_tmp 	%line{190} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:193
#   return outcol;
	assign		Result ___419_outcol 	%line{193} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:45
#   if (blend_type == "hue")
	eq		$tmp160 blend_type $const35 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{45} %argrw{"wrr"}
	if		$tmp160 415 415 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:46
#     Result = node_mix_hue(t, A, B);
	functioncall	$const36 415 	%line{46} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:198
#   color outcol = col1;
	assign		___432_outcol A 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{198} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:199
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 322 	%line{199} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp161 B $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp175 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp176 ___360_c $const17 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp179 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp180 $const16 $tmp179 	%argrw{"wrr"}
	compref		$tmp181 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp180 $tmp181 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp182 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp183 $const38 $tmp182 	%argrw{"wrr"}
	compref		$tmp184 ___360_c $const14 	%argrw{"wrr"}
	sub		___360_h $tmp183 $tmp184 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:115
#     h /= 6.0;
	div		___360_h ___360_h $const39 	%line{115} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:117
#     if (h < 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___432_hsv2 ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:201
#   if (hsv2[1] != 0.0) {
	compref		$tmp186 ___432_hsv2 $const17 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{201} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp188 ___432_outcol $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
	compref		$tmp190 ___432_outcol $const17 	%argrw{"wrr"}
	compref		$tmp191 ___432_outcol $const18 	%argrw{"wrr"}
	max		$tmp189 $tmp190 $tmp191 	%argrw{"wrr"}
	max		___360_cmax $tmp188 $tmp189 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:86
#   cmin = min(rgb[0], min(rgb[1], rgb[2]));
	compref		$tmp192 ___432_outcol $const14 	%line{86} %argrw{"wrr"}
	compref		$tmp194 ___432_outcol $const17 	%argrw{"wrr"}
	compref		$tmp195 ___432_outcol $const18 	%argrw{"wrr"}
...
#     c = (color(cmax, cmax, cmax) - rgb) / cdelta;
	...
	sub		$tmp199 $tmp198 ___432_outcol 	%argrw{"wrr"}
	div		___360_c $tmp199 ___360_cdelta 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:105
#     if (rgb[0] == cmax) {
	compref		$tmp200 ___432_outcol $const14 	%line{105} %argrw{"wrr"}
	eq		$tmp201 $tmp200 ___360_cmax 	%argrw{"wrr"}
	if		$tmp201 355 366 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp202 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp203 ___360_c $const17 	%argrw{"wrr"}
	sub		___360_h $tmp202 $tmp203 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:108
#     else if (rgb[1] == cmax) {
	compref		$tmp204 ___432_outcol $const17 	%line{108} %argrw{"wrr"}
	eq		$tmp205 $tmp204 ___360_cmax 	%argrw{"wrr"}
	if		$tmp205 362 366 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp206 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp207 $const16 $tmp206 	%argrw{"wrr"}
	compref		$tmp208 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp207 $tmp208 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp209 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp210 $const38 $tmp209 	%argrw{"wrr"}
	compref		$tmp211 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___433_hsv ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:203
#     hsv[0] = hsv2[0];
	compref		$tmp213 ___432_hsv2 $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{203} %argrw{"wrr"}
	compassign	___433_hsv $const14 $tmp213 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:204
#     color tmp = hsv_to_rgb(hsv);
	functioncall	$const40 413 	%line{204} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___369_h ___433_hsv $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
	compref		___369_s ___433_hsv $const17 	%line{131} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:132
#   v = hsv[2];
	compref		___369_v ___433_hsv $const18 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:134
#   if (s == 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:142
#     h *= 6.0;
	mul		___369_h ___369_h $const39 	%line{142} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:143
#     i = floor(h);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:156
#     else if (i == 2.0) {
	eq		$tmp224 ___369_i $const16 	%line{156} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:159
#     else if (i == 3.0) {
	eq		$tmp225 ___369_i $const41 	%line{159} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:162
#     else if (i == 4.0) {
	eq		$tmp226 ___369_i $const38 	%line{162} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:170
#   return rgb;
	assign		___433_tmp ___369_rgb 	%line{170} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:206
#     outcol = mix(outcol, tmp, t);
	mix		___432_outcol ___432_outcol ___433_tmp t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{206} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:209
#   return outcol;
	assign		Result ___432_outcol 	%line{209} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:47
#   if (blend_type == "saturation")
	eq		$tmp227 blend_type $const42 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{47} %argrw{"wrr"}
	if		$tmp227 562 562 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:48
#     Result = node_mix_sat(t, A, B);
	functioncall	$const43 562 	%line{48} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:214
#   float tm = 1.0 - t;
	sub		___434_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{214} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:216
#   color outcol = col1;
	assign		___434_outcol A 	%line{216} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:218
#   color hsv = rgb_to_hsv(outcol);
	functioncall	$const37 466 	%line{218} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp228 ___434_outcol $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
	compref		$tmp230 ___434_outcol $const17 	%argrw{"wrr"}
	compref		$tmp231 ___434_outcol $const18 	%argrw{"wrr"}
	max		$tmp229 $tmp230 $tmp231 	%argrw{"wrr"}
	max		___360_cmax $tmp228 $tmp229 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:86
#   cmin = min(rgb[0], min(rgb[1], rgb[2]));
	compref		$tmp232 ___434_outcol $const14 	%line{86} %argrw{"wrr"}
	compref		$tmp234 ___434_outcol $const17 	%argrw{"wrr"}
	compref		$tmp235 ___434_outcol $const18 	%argrw{"wrr"}
...
#     c = (color(cmax, cmax, cmax) - rgb) / cdelta;
	...
	sub		$tmp239 $tmp238 ___434_outcol 	%argrw{"wrr"}
	div		___360_c $tmp239 ___360_cdelta 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:105
#     if (rgb[0] == cmax) {
	compref		$tmp240 ___434_outcol $const14 	%line{105} %argrw{"wrr"}
	eq		$tmp241 $tmp240 ___360_cmax 	%argrw{"wrr"}
	if		$tmp241 450 461 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp242 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp243 ___360_c $const17 	%argrw{"wrr"}
	sub		___360_h $tmp242 $tmp243 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:108
#     else if (rgb[1] == cmax) {
	compref		$tmp244 ___434_outcol $const17 	%line{108} %argrw{"wrr"}
	eq		$tmp245 $tmp244 ___360_cmax 	%argrw{"wrr"}
	if		$tmp245 457 461 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp246 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp247 $const16 $tmp246 	%argrw{"wrr"}
	compref		$tmp248 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp247 $tmp248 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp249 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp250 $const38 $tmp249 	%argrw{"wrr"}
	compref		$tmp251 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___434_hsv ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:220
#   if (hsv[1] != 0.0) {
	compref		$tmp253 ___434_hsv $const17 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{220} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp255 B $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp269 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp270 ___360_c $const17 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp273 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp274 $const16 $tmp273 	%argrw{"wrr"}
	compref		$tmp275 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp274 $tmp275 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp276 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp277 $const38 $tmp276 	%argrw{"wrr"}
	compref		$tmp278 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___435_hsv2 ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:223
#     hsv[1] = tm * hsv[1] + t * hsv2[1];
	compref		$tmp280 ___434_hsv $const17 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{223} %argrw{"wrr"}
	mul		$tmp281 ___434_tm $tmp280 	%argrw{"wrr"}
	compref		$tmp282 ___435_hsv2 $const17 	%argrw{"wrr"}
	mul		$tmp283 t $tmp282 	%argrw{"wrr"}
	add		$tmp284 $tmp281 $tmp283 	%argrw{"wrr"}
	compassign	___434_hsv $const17 $tmp284 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:224
#     outcol = hsv_to_rgb(hsv);
	functioncall	$const40 561 	%line{224} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___369_h ___434_hsv $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
	compref		___369_s ___434_hsv $const17 	%line{131} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:132
#   v = hsv[2];
	compref		___369_v ___434_hsv $const18 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:134
#   if (s == 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:156
#     else if (i == 2.0) {
	eq		$tmp295 ___369_i $const16 	%line{156} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:159
#     else if (i == 3.0) {
	eq		$tmp296 ___369_i $const41 	%line{159} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:162
#     else if (i == 4.0) {
	eq		$tmp297 ___369_i $const38 	%line{162} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:170
#   return rgb;
	assign		___434_outcol ___369_rgb 	%line{170} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:227
#   return outcol;
	assign		Result ___434_outcol 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{227} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:49
#   if (blend_type == "value")
	eq		$tmp298 blend_type $const44 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{49} %argrw{"wrr"}
	if		$tmp298 704 704 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:50
#     Result = node_mix_val(t, A, B);
	functioncall	$const45 704 	%line{50} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:232
#   float tm = 1.0 - t;
	sub		___436_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{232} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:234
#   color hsv = rgb_to_hsv(col1);
	functioncall	$const37 612 	%line{234} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp299 A $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp313 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp314 ___360_c $const17 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp317 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp318 $const16 $tmp317 	%argrw{"wrr"}
	compref		$tmp319 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp318 $tmp319 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp320 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp321 $const38 $tmp320 	%argrw{"wrr"}
	compref		$tmp322 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___436_hsv ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:235
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 658 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{235} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp324 B $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp338 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp339 ___360_c $const17 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp342 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp343 $const16 $tmp342 	%argrw{"wrr"}
	compref		$tmp344 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp343 $tmp344 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp345 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp346 $const38 $tmp345 	%argrw{"wrr"}
	compref		$tmp347 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___436_hsv2 ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:237
#   hsv[2] = tm * hsv[2] + t * hsv2[2];
	compref		$tmp349 ___436_hsv $const18 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{237} %argrw{"wrr"}
	mul		$tmp350 ___436_tm $tmp349 	%argrw{"wrr"}
	compref		$tmp351 ___436_hsv2 $const18 	%argrw{"wrr"}
	mul		$tmp352 t $tmp351 	%argrw{"wrr"}
	add		$tmp353 $tmp350 $tmp352 	%argrw{"wrr"}
	compassign	___436_hsv $const18 $tmp353 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:239
#   return hsv_to_rgb(hsv);
	functioncall	$const40 704 	%line{239} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___369_h ___436_hsv $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
	compref		___369_s ___436_hsv $const17 	%line{131} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:132
#   v = hsv[2];
	compref		___369_v ___436_hsv $const18 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:134
#   if (s == 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:156
#     else if (i == 2.0) {
	eq		$tmp364 ___369_i $const16 	%line{156} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:159
#     else if (i == 3.0) {
	eq		$tmp365 ___369_i $const41 	%line{159} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:162
#     else if (i == 4.0) {
	eq		$tmp366 ___369_i $const38 	%line{162} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:170
#   return rgb;
	assign		Result ___369_rgb 	%line{170} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:51
#   if (blend_type == "color")
	eq		$tmp367 blend_type $const46 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{51} %argrw{"wrr"}
	if		$tmp367 849 849 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:52
#     Result = node_mix_color(t, A, B);
	functioncall	$const47 849 	%line{52} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:244
#   color outcol = col1;
	assign		___437_outcol A 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{244} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:245
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 754 	%line{245} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp368 B $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp382 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp383 ___360_c $const17 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp386 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp387 $const16 $tmp386 	%argrw{"wrr"}
	compref		$tmp388 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp387 $tmp388 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp389 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp390 $const38 $tmp389 	%argrw{"wrr"}
	compref		$tmp391 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___437_hsv2 ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:247
#   if (hsv2[1] != 0.0) {
	compref		$tmp393 ___437_hsv2 $const17 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{247} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp395 ___437_outcol $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
	compref		$tmp397 ___437_outcol $const17 	%argrw{"wrr"}
	compref		$tmp398 ___437_outcol $const18 	%argrw{"wrr"}
	max		$tmp396 $tmp397 $tmp398 	%argrw{"wrr"}
	max		___360_cmax $tmp395 $tmp396 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:86
#   cmin = min(rgb[0], min(rgb[1], rgb[2]));
	compref		$tmp399 ___437_outcol $const14 	%line{86} %argrw{"wrr"}
	compref		$tmp401 ___437_outcol $const17 	%argrw{"wrr"}
	compref		$tmp402 ___437_outcol $const18 	%argrw{"wrr"}
...
#     c = (color(cmax, cmax, cmax) - rgb) / cdelta;
	...
	sub		$tmp406 $tmp405 ___437_outcol 	%argrw{"wrr"}
	div		___360_c $tmp406 ___360_cdelta 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:105
#     if (rgb[0] == cmax) {
	compref		$tmp407 ___437_outcol $const14 	%line{105} %argrw{"wrr"}
	eq		$tmp408 $tmp407 ___360_cmax 	%argrw{"wrr"}
	if		$tmp408 787 798 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp409 ___360_c $const18 	%line{106} %argrw{"wrr"}
	compref		$tmp410 ___360_c $const17 	%argrw{"wrr"}
	sub		___360_h $tmp409 $tmp410 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:108
#     else if (rgb[1] == cmax) {
	compref		$tmp411 ___437_outcol $const17 	%line{108} %argrw{"wrr"}
	eq		$tmp412 $tmp411 ___360_cmax 	%argrw{"wrr"}
	if		$tmp412 794 798 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp413 ___360_c $const14 	%line{109} %argrw{"wrr"}
	add		$tmp414 $const16 $tmp413 	%argrw{"wrr"}
	compref		$tmp415 ___360_c $const18 	%argrw{"wrr"}
	sub		___360_h $tmp414 $tmp415 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp416 ___360_c $const17 	%line{112} %argrw{"wrr"}
	add		$tmp417 $const38 $tmp416 	%argrw{"wrr"}
	compref		$tmp418 ___360_c $const14 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		___438_hsv ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:249
#     hsv[0] = hsv2[0];
	compref		$tmp420 ___437_hsv2 $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{249} %argrw{"wrr"}
	compassign	___438_hsv $const14 $tmp420 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:250
#     hsv[1] = hsv2[1];
	compref		$tmp421 ___437_hsv2 $const17 	%line{250} %argrw{"wrr"}
	compassign	___438_hsv $const17 $tmp421 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:251
#     color tmp = hsv_to_rgb(hsv);
	functioncall	$const40 847 	%line{251} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___369_h ___438_hsv $const14 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
	compref		___369_s ___438_hsv $const17 	%line{131} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:132
#   v = hsv[2];
	compref		___369_v ___438_hsv $const18 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:134
#   if (s == 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:156
#     else if (i == 2.0) {
	eq		$tmp432 ___369_i $const16 	%line{156} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:159
#     else if (i == 3.0) {
	eq		$tmp433 ___369_i $const41 	%line{159} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:162
#     else if (i == 4.0) {
	eq		$tmp434 ___369_i $const38 	%line{162} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:170
#   return rgb;
	assign		___438_tmp ___369_rgb 	%line{170} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:253
#     outcol = mix(outcol, tmp, t);
	mix		___437_outcol ___437_outcol ___438_tmp t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{253} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:256
#   return outcol;
	assign		Result ___437_outcol 	%line{256} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:53
#   if (blend_type == "soft_light")
	eq		$tmp435 blend_type $const48 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{53} %argrw{"wrr"}
	if		$tmp435 866 866 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:54
#     Result = node_mix_soft(t, A, B);
	functioncall	$const49 866 	%line{54} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:261
#   float tm = 1.0 - t;
	sub		___439_tm $const2 t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{261} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:263
#   color one = color(1.0);
	assign		___439_one $const11 	%line{263} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:264
#   color scr = one - (one - col2) * (one - col1);
	sub		$tmp436 ___439_one B 	%line{264} %argrw{"wrr"}
	sub		$tmp437 ___439_one A 	%argrw{"wrr"}
	mul		$tmp438 $tmp436 $tmp437 	%argrw{"wrr"}
	sub		___439_scr ___439_one $tmp438 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:266
#   return tm * col1 + t * ((one - col1) * col2 * col1 + col1 * scr);
	mul		$tmp439 ___439_tm A 	%line{266} %argrw{"wrr"}
	sub		$tmp440 ___439_one A 	%argrw{"wrr"}
	mul		$tmp441 $tmp440 B 	%argrw{"wrr"}
	mul		$tmp442 $tmp441 A 	%argrw{"wrr"}
	mul		$tmp443 A ___439_scr 	%argrw{"wrr"}
	add		$tmp444 $tmp442 $tmp443 	%argrw{"wrr"}
	mul		$tmp445 t $tmp444 	%argrw{"wrr"}
	add		Result $tmp439 $tmp445 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:55
#   if (blend_type == "linear_light")
	eq		$tmp446 blend_type $const50 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{55} %argrw{"wrr"}
	if		$tmp446 922 922 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:56
#     Result = node_mix_linear(t, A, B);
	functioncall	$const51 922 	%line{56} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:271
#   color outcol = col1;
	assign		___440_outcol A 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{271} %argrw{"wr"}
...
#     outcol[0] = col1[0] + t * (2.0 * (col2[0] - 0.5));
	...
	compassign	___440_outcol $const14 $tmp454 	%argrw{"wrr"}
...
#     outcol[0] = col1[0] + t * (2.0 * (col2[0]) - 1.0);
	...
	compassign	___440_outcol $const14 $tmp460 	%argrw{"wrr"}
...
#     outcol[1] = col1[1] + t * (2.0 * (col2[1] - 0.5));
	...
	compassign	___440_outcol $const17 $tmp468 	%argrw{"wrr"}
...
#     outcol[1] = col1[1] + t * (2.0 * (col2[1]) - 1.0);
	...
	compassign	___440_outcol $const17 $tmp474 	%argrw{"wrr"}
...
#     outcol[2] = col1[2] + t * (2.0 * (col2[2] - 0.5));
	...
	compassign	___440_outcol $const18 $tmp482 	%argrw{"wrr"}
...
#     outcol[2] = col1[2] + t * (2.0 * (col2[2]) - 1.0);
	...
	compassign	___440_outcol $const18 $tmp488 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:294
#   return outcol;
	assign		Result ___440_outcol 	%line{294} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:58
#   if (use_clamp_result)
	if		use_clamp_result 928 928 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{58} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:59
#     Result = clamp(Result, 0.0, 1.0);
	assign		$tmp489 $const1 	%line{59} %argrw{"wr"}
	assign		$tmp490 $const2 	%argrw{"wr"}
	functioncall	$const3 928 	%argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:140
# color  clamp (color x, color minval, color maxval) { return max(min(x,maxval),minval); }
	min		$tmp491 Result $tmp490 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{140} %argrw{"wrr"}
