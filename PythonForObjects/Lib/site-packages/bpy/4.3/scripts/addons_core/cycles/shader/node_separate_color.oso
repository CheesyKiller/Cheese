...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_separate_color.oso
...
local	float	___360_cmax	%read{16,36} %write{10,10}
local	float	___360_cmin	%read{16,16} %write{15,15}
local	float	___360_h	%read{46,50} %write{22,49}
local	float	___360_s	%read{23,50} %write{20,21}
local	float	___360_v	%read{50,50} %write{17,17}
local	float	___360_cdelta	%read{20,28} %write{16,16}
local	color	___360_c	%read{32,44} %write{28,28}
local	float	___379_cmax	%read{64,94} %write{58,58}
local	float	___379_cmin	%read{64,77} %write{63,63}
local	float	___379_h	%read{106,107} %write{70,106}
local	float	___379_s	%read{70,107} %write{69,78}
local	float	___379_l	%read{72,107} %write{66,66}
local	float	___381_cdelta	%read{76,104} %write{71,71}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:15
#   if (color_type == "rgb")
	eq		$tmp1 color_type $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{15} %argrw{"wrr"}
	if		$tmp1 3 110 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:16
#     col = Color;
	assign		col Color 	%line{16} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:17
#   else if (color_type == "hsv")
	eq		$tmp2 color_type $const2 	%line{17} %argrw{"wrr"}
	if		$tmp2 51 110 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:18
...
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp3 Color $const4 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
	compref		$tmp5 Color $const5 	%argrw{"wrr"}
	compref		$tmp6 Color $const6 	%argrw{"wrr"}
	max		$tmp4 $tmp5 $tmp6 	%argrw{"wrr"}
	max		___360_cmax $tmp3 $tmp4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:86
#   cmin = min(rgb[0], min(rgb[1], rgb[2]));
	...
	min		___360_cmin $tmp7 $tmp8 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:87
#   cdelta = cmax - cmin;
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:91
#   if (cmax != 0.0) {
	neq		$tmp11 ___360_cmax $const7 	%line{91} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:95
#     s = 0.0;
	assign		___360_s $const7 	%line{95} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:96
#     h = 0.0;
	assign		___360_h $const7 	%line{96} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:99
#   if (s == 0.0) {
	eq		$tmp12 ___360_s $const7 	%line{99} %argrw{"wrr"}
	if		$tmp12 26 50 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:100
#     h = 0.0;
	assign		___360_h $const7 	%line{100} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:103
#     c = (color(cmax, cmax, cmax) - rgb) / cdelta;
	color		$tmp13 ___360_cmax ___360_cmax ___360_cmax 	%line{103} %argrw{"wrrr"}
	sub		$tmp14 $tmp13 Color 	%argrw{"wrr"}
	div		___360_c $tmp14 ___360_cdelta 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:105
#     if (rgb[0] == cmax) {
	compref		$tmp15 Color $const4 	%line{105} %argrw{"wrr"}
	eq		$tmp16 $tmp15 ___360_cmax 	%argrw{"wrr"}
	if		$tmp16 35 46 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:106
#       h = c[2] - c[1];
	compref		$tmp17 ___360_c $const6 	%line{106} %argrw{"wrr"}
	compref		$tmp18 ___360_c $const5 	%argrw{"wrr"}
	sub		___360_h $tmp17 $tmp18 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:108
#     else if (rgb[1] == cmax) {
	compref		$tmp19 Color $const5 	%line{108} %argrw{"wrr"}
	eq		$tmp20 $tmp19 ___360_cmax 	%argrw{"wrr"}
	if		$tmp20 42 46 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:109
#       h = 2.0 + c[0] - c[2];
	compref		$tmp21 ___360_c $const4 	%line{109} %argrw{"wrr"}
	add		$tmp22 $const8 $tmp21 	%argrw{"wrr"}
	compref		$tmp23 ___360_c $const6 	%argrw{"wrr"}
	sub		___360_h $tmp22 $tmp23 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:112
#       h = 4.0 + c[1] - c[0];
	compref		$tmp24 ___360_c $const5 	%line{112} %argrw{"wrr"}
	add		$tmp25 $const9 $tmp24 	%argrw{"wrr"}
	compref		$tmp26 ___360_c $const4 	%argrw{"wrr"}
	sub		___360_h $tmp25 $tmp26 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:115
#     h /= 6.0;
	div		___360_h ___360_h $const10 	%line{115} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:117
#     if (h < 0.0) {
	lt		$tmp27 ___360_h $const7 	%line{117} %argrw{"wrr"}
	if		$tmp27 50 50 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:118
#       h += 1.0;
	add		___360_h ___360_h $const11 	%line{118} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		col ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:19
#   else if (color_type == "hsl")
	eq		$tmp28 color_type $const12 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{19} %argrw{"wrr"}
	if		$tmp28 109 110 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:20
#     col = rgb_to_hsl(Color);
	functioncall	$const13 109 	%line{20} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:177
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp29 Color $const4 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{177} %argrw{"wrr"}
	compref		$tmp31 Color $const5 	%argrw{"wrr"}
	compref		$tmp32 Color $const6 	%argrw{"wrr"}
	max		$tmp30 $tmp31 $tmp32 	%argrw{"wrr"}
	max		___379_cmax $tmp29 $tmp30 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:178
#   cmin = min(rgb[0], min(rgb[1], rgb[2]));
	...
	min		___379_cmin $tmp33 $tmp34 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:179
#   l = min(1.0, (cmax + cmin) / 2.0);
	add		$tmp37 ___379_cmax ___379_cmin 	%line{179} %argrw{"wrr"}
	div		$tmp38 $tmp37 $const8 	%argrw{"wrr"}
	min		___379_l $const11 $tmp38 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:181
#   if (cmax == cmin) {
	eq		$tmp39 ___379_cmax ___379_cmin 	%line{181} %argrw{"wrr"}
	if		$tmp39 71 106 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:182
#     h = s = 0.0; /* achromatic */
	assign		___379_s $const7 	%line{182} %argrw{"wr"}
	assign		___379_h ___379_s 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:185
#     float cdelta = cmax - cmin;
	sub		___381_cdelta ___379_cmax ___379_cmin 	%line{185} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:186
#     s = l > 0.5 ? cdelta / (2.0 - cmax - cmin) : cdelta / (cmax + cmin);
	gt		$tmp40 ___379_l $const14 	%line{186} %argrw{"wrr"}
	if		$tmp40 77 79 	%argrw{"r"}
	sub		$tmp41 $const8 ___379_cmax 	%argrw{"wrr"}
	sub		$tmp42 $tmp41 ___379_cmin 	%argrw{"wrr"}
	div		___379_s ___381_cdelta $tmp42 	%argrw{"wrr"}
	add		$tmp43 ___379_cmax ___379_cmin 	%argrw{"wrr"}
	div		___379_s ___381_cdelta $tmp43 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:187
#     if (cmax == rgb[0]) {
	compref		$tmp44 Color $const4 	%line{187} %argrw{"wrr"}
	eq		$tmp45 ___379_cmax $tmp44 	%argrw{"wrr"}
...
#       h = (rgb[1] - rgb[2]) / cdelta + (rgb[1] < rgb[2] ? 6.0 : 0.0);
	...
	div		$tmp49 $tmp48 ___381_cdelta 	%argrw{"wrr"}
	...
	add		___379_h $tmp49 $tmp50 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:190
#     else if (cmax == rgb[1]) {
	compref		$tmp54 Color $const5 	%line{190} %argrw{"wrr"}
	eq		$tmp55 ___379_cmax $tmp54 	%argrw{"wrr"}
...
#       h = (rgb[2] - rgb[0]) / cdelta + 2.0;
	...
	div		$tmp59 $tmp58 ___381_cdelta 	%argrw{"wrr"}
	add		___379_h $tmp59 $const8 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:194
#       h = (rgb[0] - rgb[1]) / cdelta + 4.0;
	...
	div		$tmp63 $tmp62 ___381_cdelta 	%argrw{"wrr"}
	add		___379_h $tmp63 $const9 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:197
#   h /= 6.0;
	div		___379_h ___379_h $const10 	%line{197} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:199
#   return color(h, s, l);
	color		col ___379_h ___379_s ___379_l 	%line{199} %argrw{"wrrr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:22
#     warning("%s", "Unknown color space!");
	warning		$const15 $const16 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{22} %argrw{"rr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:24
#   Red = col[0];
	compref		Red col $const4 	%line{24} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:25
#   Green = col[1];
	compref		Green col $const5 	%line{25} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_separate_color.osl:26
#   Blue = col[2];
