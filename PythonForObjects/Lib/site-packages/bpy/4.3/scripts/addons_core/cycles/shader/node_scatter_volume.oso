...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_scatter_volume.oso
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl:12
#   Volume = (Color * max(Density, 0.0)) * henyey_greenstein(Anisotropy);
	closure		$tmp1 $const1 Anisotropy 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl"} %line{12} %argrw{"wrr"}
