...
export {
	...
	constexpr auto GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER = 0x92C8;
	constexpr auto GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER = 0x92C9;
	...
	constexpr auto GL_DISPLAY_LIST = 0x82E7;
