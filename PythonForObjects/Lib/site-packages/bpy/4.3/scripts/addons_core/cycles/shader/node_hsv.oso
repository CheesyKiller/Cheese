...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_hsv.oso
shader node_hsv
...
local	float	___369_i	%read{72,95} %write{71,71}
local	float	___369_f	%read{73,79} %write{72,72}
local	float	___369_p	%read{85,98} %write{75,75}
local	float	___369_q	%read{88,98} %write{78,78}
local	float	___369_t	%read{85,97} %write{82,82}
local	float	___369_h	%read{67,72} %write{61,70}
local	float	___369_s	%read{64,80} %write{62,62}
local	float	___369_v	%read{66,98} %write{63,63}
local	color	___369_rgb	%read{99,99} %write{66,98}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:15
#   color Color = rgb_to_hsv(ColorIn);
	functioncall	$const1 46 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{15} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp1 ColorIn $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:122
#   return color(h, s, v);
	color		Color ___360_h ___360_s ___360_v 	%line{122} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:18
#   Color[0] = fmod(Color[0] + Hue + 0.5, 1.0);
	compref		$tmp27 Color $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{18} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:19
#   Color[1] = clamp(Color[1] * Saturation, 0.0, 1.0);
	compref		$tmp31 Color $const3 	%line{19} %argrw{"wrr"}
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp33 $tmp32 $const9 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp30 $tmp33 $const5 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:19
#   Color[1] = clamp(Color[1] * Saturation, 0.0, 1.0);
	compassign	Color $const3 $tmp30 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{19} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:20
#   Color[2] *= Value;
	compref		$tmp34 Color $const4 	%line{20} %argrw{"wrr"}
	mul		$tmp35 $tmp34 Value 	%argrw{"wrr"}
	compassign	Color $const4 $tmp35 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:22
#   Color = hsv_to_rgb(Color);
	functioncall	$const12 100 	%line{22} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___369_h Color $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
	compref		___369_s Color $const3 	%line{131} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:132
#   v = hsv[2];
	compref		___369_v Color $const4 	%line{132} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:134
#   if (s == 0.0) {
	eq		$tmp36 ___369_s $const5 	%line{134} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:138
#     if (h == 1.0) {
	eq		$tmp37 ___369_h $const9 	%line{138} %argrw{"wrr"}
	if		$tmp37 70 70 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:139
#       h = 0.0;
	assign		___369_h $const5 	%line{139} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:142
#     h *= 6.0;
	mul		___369_h ___369_h $const8 	%line{142} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:143
#     i = floor(h);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:146
#     p = v * (1.0 - s);
	sub		$tmp38 $const9 ___369_s 	%line{146} %argrw{"wrr"}
	mul		___369_p ___369_v $tmp38 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:147
#     q = v * (1.0 - (s * f));
	mul		$tmp39 ___369_s ___369_f 	%line{147} %argrw{"wrr"}
	sub		$tmp40 $const9 $tmp39 	%argrw{"wrr"}
	mul		___369_q ___369_v $tmp40 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:148
#     t = v * (1.0 - (s * (1.0 - f)));
	sub		$tmp41 $const9 ___369_f 	%line{148} %argrw{"wrr"}
	mul		$tmp42 ___369_s $tmp41 	%argrw{"wrr"}
	sub		$tmp43 $const9 $tmp42 	%argrw{"wrr"}
	mul		___369_t ___369_v $tmp43 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:150
#     if (i == 0.0) {
	eq		$tmp44 ___369_i $const5 	%line{150} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:153
#     else if (i == 1.0) {
	eq		$tmp45 ___369_i $const9 	%line{153} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:156
#     else if (i == 2.0) {
	eq		$tmp46 ___369_i $const6 	%line{156} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:159
#     else if (i == 3.0) {
	eq		$tmp47 ___369_i $const13 	%line{159} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:162
#     else if (i == 4.0) {
	eq		$tmp48 ___369_i $const7 	%line{162} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:25
#   Color[0] = max(Color[0], 0.0);
	compref		$tmp50 Color $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{25} %argrw{"wrr"}
	max		$tmp49 $tmp50 $const5 	%argrw{"wrr"}
	compassign	Color $const2 $tmp49 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:26
#   Color[1] = max(Color[1], 0.0);
	compref		$tmp52 Color $const3 	%line{26} %argrw{"wrr"}
	max		$tmp51 $tmp52 $const5 	%argrw{"wrr"}
	compassign	Color $const3 $tmp51 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:27
#   Color[2] = max(Color[2], 0.0);
	compref		$tmp54 Color $const4 	%line{27} %argrw{"wrr"}
	max		$tmp53 $tmp54 $const5 	%argrw{"wrr"}
	compassign	Color $const4 $tmp53 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:29
