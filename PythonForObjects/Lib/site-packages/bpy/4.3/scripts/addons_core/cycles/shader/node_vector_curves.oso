...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_vector_curves.oso
...
param	vector	VectorIn	0 0 0		%read{1,196} %write{2147483647,-1}
param	float	Fac	0		%read{196,196} %write{2147483647,-1}
oparam	vector	VectorOut	0 0 0		%read{196,196} %write{191,196}
...
local	vector	c	%read{4,128} %write{3,3}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:17
#   vector c = (VectorIn - vector(min_x, min_x, min_x)) / (max_x - min_x);
	vector		$tmp1 min_x min_x min_x 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{17} %argrw{"wrrr"}
	sub		$tmp2 VectorIn $tmp1 	%argrw{"wrr"}
	sub		$tmp3 max_x min_x 	%argrw{"wrr"}
	div		c $tmp2 $tmp3 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:19
...
#   float f = at;
	assign		___344_f $tmp4 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
#   int table_size = arraylength(ramp);
	arraylength	___344_table_size ramp 	%line{10} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:12
#   if ((f < 0.0 || f > 1.0) && extrapolate) {
	lt		$tmp5 ___344_f $const4 	%line{12} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:14
#     if (f < 0.0) {
	lt		$tmp11 ___344_f $const4 	%line{14} %argrw{"wrr"}
	if		$tmp11 25 31 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:15
#       t0 = ramp[0];
	aref		___345_t0 ramp $const1 	%line{15} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:16
#       dy = t0 - ramp[1];
...
#       t0 = ramp[table_size - 1];
	sub		$tmp13 ___344_table_size $const2 	%line{20} %argrw{"wrr"}
	aref		___345_t0 ramp $tmp13 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:21
#       dy = t0 - ramp[table_size - 2];
	sub		$tmp14 ___344_table_size $const6 	%line{21} %argrw{"wrr"}
	aref		$tmp15 ramp $tmp14 	%argrw{"wrr"}
	sub		___345_dy ___345_t0 $tmp15 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:22
#       f = f - 1.0;
	sub		___344_f ___344_f $const5 	%line{22} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:24
#     return t0 + dy * f * (table_size - 1);
	mul		$tmp16 ___345_dy ___344_f 	%line{24} %argrw{"wrr"}
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp21 $tmp4 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp20 $tmp21 $const4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp22 ___344_table_size $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:31
#   if (i < 0) {
	lt		$tmp24 ___344_i $const1 	%line{31} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:34
#   if (i >= table_size) {
	ge		$tmp25 ___344_i ___344_table_size 	%line{34} %argrw{"wrr"}
	if		$tmp25 50 50 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:35
#     i = table_size - 1;
	sub		___344_i ___344_table_size $const2 	%line{35} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:37
#   float t = f - (float)i;
	assign		$tmp26 ___344_i 	%line{37} %argrw{"wr"}
	sub		___344_t ___344_f $tmp26 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:39
#   color result = ramp[i];
	aref		___344_result ramp ___344_i 	%line{39} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:41
...
#     result = (1.0 - t) * result + t * ramp[i + 1];
	sub		$tmp30 $const5 ___344_t 	%line{42} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:45
#   return result;
	assign		r ___344_result 	%line{45} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:20
#   color g = rgb_ramp_lookup(ramp, c[0], 1, extrapolate);
	compref		$tmp35 c $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{20} %argrw{"wrr"}
	functioncall	$const3 128 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:9
#   float f = at;
	assign		___344_f $tmp35 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
#   int table_size = arraylength(ramp);
	arraylength	___344_table_size ramp 	%line{10} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:12
#   if ((f < 0.0 || f > 1.0) && extrapolate) {
	lt		$tmp36 ___344_f $const4 	%line{12} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:14
#     if (f < 0.0) {
	lt		$tmp42 ___344_f $const4 	%line{14} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:20
#       t0 = ramp[table_size - 1];
	sub		$tmp44 ___344_table_size $const2 	%line{20} %argrw{"wrr"}
	aref		___345_t0 ramp $tmp44 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:21
#       dy = t0 - ramp[table_size - 2];
	sub		$tmp45 ___344_table_size $const6 	%line{21} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:24
#     return t0 + dy * f * (table_size - 1);
	mul		$tmp47 ___345_dy ___344_f 	%line{24} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp52 $tmp35 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp51 $tmp52 $const4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp53 ___344_table_size $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:31
#   if (i < 0) {
	lt		$tmp55 ___344_i $const1 	%line{31} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:34
#   if (i >= table_size) {
	ge		$tmp56 ___344_i ___344_table_size 	%line{34} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:37
#   float t = f - (float)i;
	assign		$tmp57 ___344_i 	%line{37} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:42
#     result = (1.0 - t) * result + t * ramp[i + 1];
	sub		$tmp61 $const5 ___344_t 	%line{42} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:45
#   return result;
	assign		g ___344_result 	%line{45} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:21
#   color b = rgb_ramp_lookup(ramp, c[0], 1, extrapolate);
	compref		$tmp66 c $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{21} %argrw{"wrr"}
	functioncall	$const3 190 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:9
#   float f = at;
	assign		___344_f $tmp66 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
#   int table_size = arraylength(ramp);
	arraylength	___344_table_size ramp 	%line{10} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:12
#   if ((f < 0.0 || f > 1.0) && extrapolate) {
	lt		$tmp67 ___344_f $const4 	%line{12} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:14
#     if (f < 0.0) {
	lt		$tmp73 ___344_f $const4 	%line{14} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:20
#       t0 = ramp[table_size - 1];
	sub		$tmp75 ___344_table_size $const2 	%line{20} %argrw{"wrr"}
	aref		___345_t0 ramp $tmp75 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:21
#       dy = t0 - ramp[table_size - 2];
	sub		$tmp76 ___344_table_size $const6 	%line{21} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:24
#     return t0 + dy * f * (table_size - 1);
	mul		$tmp78 ___345_dy ___344_f 	%line{24} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp83 $tmp66 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp82 $tmp83 $const4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp84 ___344_table_size $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:31
#   if (i < 0) {
	lt		$tmp86 ___344_i $const1 	%line{31} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:34
#   if (i >= table_size) {
	ge		$tmp87 ___344_i ___344_table_size 	%line{34} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:37
#   float t = f - (float)i;
	assign		$tmp88 ___344_i 	%line{37} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:42
#     result = (1.0 - t) * result + t * ramp[i + 1];
	sub		$tmp92 $const5 ___344_t 	%line{42} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:45
#   return result;
	assign		b ___344_result 	%line{45} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:23
#   VectorOut[0] = r[0];
	compref		$tmp97 r $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{23} %argrw{"wrr"}
	compassign	VectorOut $const1 $tmp97 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:24
#   VectorOut[1] = g[1];
	compref		$tmp98 g $const2 	%line{24} %argrw{"wrr"}
	compassign	VectorOut $const2 $tmp98 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:25
#   VectorOut[2] = b[2];
	compref		$tmp99 b $const6 	%line{25} %argrw{"wrr"}
	compassign	VectorOut $const6 $tmp99 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:27
#   VectorOut = mix(VectorIn, VectorOut, Fac);
	mix		VectorOut VectorIn VectorOut Fac 	%line{27} %argrw{"wrrr"}
	end
