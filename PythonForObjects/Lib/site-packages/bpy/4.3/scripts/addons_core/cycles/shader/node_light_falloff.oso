...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_light_falloff.oso
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:13
#   float ray_length = 0.0;
	assign		ray_length $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl"} %line{13} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:14
#   float strength = Strength;
	assign		strength Strength 	%line{14} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:15
#   getattribute("path:ray_length", ray_length);
	getattribute	$tmp1 $const2 ray_length 	%line{15} %argrw{"wrw"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:17
#   if (Smooth > 0.0) {
	gt		$tmp2 Smooth $const1 	%line{17} %argrw{"wrr"}
	if		$tmp2 9 9 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:18
#     float squared = ray_length * ray_length;
	mul		___362_squared ray_length ray_length 	%line{18} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:19
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:23
#   Quadratic = strength;
	assign		Quadratic strength 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:26
#   Linear = (strength * ray_length);
	mul		Linear strength ray_length 	%line{26} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:29
