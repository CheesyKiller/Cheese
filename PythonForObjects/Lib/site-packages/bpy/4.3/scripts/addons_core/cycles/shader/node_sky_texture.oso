...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_sky_texture.oso
...
code Vector
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:203
#     vector Vector = P,
	assign		Vector P 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl"} %line{203} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:215
#   vector p = Vector;
	assign		p Vector 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl"} %line{215} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:217
#   if (use_mapping)
	if		use_mapping 4 4 	%line{217} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:218
#     p = transform(mapping, p);
	transformv	p mapping p 	%line{218} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:220
#   if (sky_type == "nishita_improved")
	eq		$tmp1 sky_type $const1 	%line{220} %argrw{"wrr"}
	if		$tmp1 139 139 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:221
#     Color = sky_radiance_nishita(p, nishita_data, filename);
	functioncall	$const2 139 	%line{221} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:121
#   float sun_elevation = nishita_data[6];
	aref		___412_sun_elevation nishita_data $const3 	%line{121} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:122
#   float sun_rotation = nishita_data[7];
	aref		___412_sun_rotation nishita_data $const4 	%line{122} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:123
#   float angular_diameter = nishita_data[8];
	aref		___412_angular_diameter nishita_data $const5 	%line{123} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:124
#   float sun_intensity = nishita_data[9];
	aref		___412_sun_intensity nishita_data $const6 	%line{124} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:125
#   int sun_disc = angular_diameter > 0;
	gt		___412_sun_disc ___412_angular_diameter $const7 	%line{125} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:126
#   float alpha = 1.0;
	assign		___412_alpha $const8 	%line{126} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:129
#   vector direction = sky_spherical_coordinates(dir);
	functioncall	$const9 20 	%line{129} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:22
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:132
#   if (dir[2] >= 0.0) {
	compref		$tmp7 p $const10 	%line{132} %argrw{"wrr"}
	ge		$tmp8 $tmp7 $const12 	%argrw{"wrr"}
	if		$tmp8 101 119 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:134
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:110
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:135
#     float sun_dir_angle = precise_angle(dir, sun_dir);
	functioncall	$const15 40 	%line{135} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:115
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:136
#     float half_angular = angular_diameter * 0.5;
	mul		___413_half_angular ___412_angular_diameter $const17 	%line{136} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:137
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:141
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:143
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:144
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:148
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:149
#         if ((sun_elevation + half_angular) > 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:150
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:151
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:155
#         if (sun_elevation + half_angular > 0.0) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:156
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:157
#           xyz = mix(pixel_bottom, pixel_top, y) * sun_intensity;
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:161
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:162
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:163
#       xyz *= limb_darkening;
	mul		___412_xyz ___412_xyz ___414_limb_darkening 	%line{163} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:168
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:170
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:171
#       if (x > 1.0) {
	gt		$tmp58 ___419_x $const8 	%line{171} %argrw{"wrr"}
	if		$tmp58 100 100 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:172
#         x = x - 1.0;
	sub		___419_x ___419_x $const8 	%line{172} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:174
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:179
#     if (dir[2] < -0.4) {
	compref		$tmp59 p $const10 	%line{179} %argrw{"wrr"}
	lt		$tmp60 $tmp59 $const30 	%argrw{"wrr"}
	if		$tmp60 105 119 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:180
#       xyz = color(0, 0, 0);
	assign		___412_xyz $const31 	%line{180} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:184
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:186
#       float x = (direction[1] + M_PI + sun_rotation) / M_2PI;
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:187
#       float y = 1.5;
	assign		___423_y $const34 	%line{187} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:188
#       if (x > 1.0) {
	gt		$tmp67 ___423_x $const8 	%line{188} %argrw{"wrr"}
	if		$tmp67 117 117 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:189
#         x = x - 1.0;
	sub		___423_x ___423_x $const8 	%line{189} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:191
#       xyz = (color)texture(
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:192
#                 filename, x, y, "wrap", "periodic", "interp", "linear", "alpha", alpha) *
	mul		___412_xyz $tmp68 ___423_mul 	%line{192} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:197
...
#   return color(3.240479 * x + -1.537150 * y + -0.498535 * z,
	mul		$tmp72 $const37 $tmp69 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{75} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:222
#   if (sky_type == "hosek_wilkie")
	eq		$tmp87 sky_type $const46 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl"} %line{222} %argrw{"wrr"}
	if		$tmp87 317 317 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:223
#     Color = sky_radiance_hosek(p, phi, theta, radiance, config_x, config_y, config_z);
	functioncall	$const47 317 	%line{223} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:88
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:89
#   float theta = spherical[0];
	compref		___409_theta ___409_spherical $const7 	%line{89} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:90
#   float phi = spherical[1];
	compref		___409_phi ___409_spherical $const11 	%line{90} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:93
#   float gamma = sky_angle_between(theta, phi, suntheta, sunphi);
	functioncall	$const48 171 	%line{93} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:10
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:12
#   if (cospsi > 1.0)
	gt		$tmp102 ___404_cospsi $const8 	%line{12} %argrw{"wrr"}
	if		$tmp102 166 166 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:13
#     return 0.0;
	assign		___409_gamma $const12 	%line{13} %argrw{"wr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:14
#   if (cospsi < -1.0)
	lt		$tmp103 ___404_cospsi $const49 	%line{14} %argrw{"wrr"}
	if		$tmp103 170 170 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:15
#     return M_PI;
	assign		___409_gamma $const23 	%line{15} %argrw{"wr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:17
#   return acos(cospsi);
	acos		___409_gamma ___404_cospsi 	%line{17} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:96
#   theta = min(theta, M_PI_2 - 0.001);
	min		___409_theta ___409_theta $const50 	%line{96} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:99
#   float x = sky_radiance_internal(config_x, theta, gamma) * radiance[0];
	functioncall	$const51 212 	%line{99} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:67
#   float ctheta = cos(theta);
	cos		___408_ctheta ___409_theta 	%line{67} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:68
#   float cgamma = cos(gamma);
	cos		___408_cgamma ___409_gamma 	%line{68} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:70
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:71
#   float rayM = cgamma * cgamma;
	mul		___408_rayM ___408_cgamma ___408_cgamma 	%line{71} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:72
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:73
#   float zenith = sqrt(ctheta);
	sqrt		___408_zenith ___408_ctheta 	%line{73} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:75
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:76
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:100
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:101
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:104
#   return xyz_to_rgb(x, y, z) * (M_2PI / 683);
	functioncall	$const36 315 	%line{104} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:75
#   return color(3.240479 * x + -1.537150 * y + -0.498535 * z,
	mul		$tmp207 $const37 ___409_x 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{75} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:104
#   return xyz_to_rgb(x, y, z) * (M_2PI / 683);
	div		$tmp222 $const24 $const54 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl"} %line{104} %argrw{"wrr"}
	mul		Color $tmp206 $tmp222 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:224
#   if (sky_type == "preetham")
	eq		$tmp223 sky_type $const55 	%line{224} %argrw{"wrr"}
	if		$tmp223 455 455 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:225
#     Color = sky_radiance_preetham(p, phi, theta, radiance, config_x, config_y, config_z);
	functioncall	$const56 455 	%line{225} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:44
#   vector spherical = sky_spherical_coordinates(dir);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:45
#   float theta = spherical[0];
	compref		___407_theta ___407_spherical $const7 	%line{45} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:46
#   float phi = spherical[1];
	compref		___407_phi ___407_spherical $const11 	%line{46} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:49
#   float gamma = sky_angle_between(theta, phi, suntheta, sunphi);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:52
#   theta = min(theta, M_PI_2 - 0.001);
	min		___407_theta ___407_theta $const50 	%line{52} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:55
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:28
#   float ctheta = cos(theta);
	cos		___406_ctheta ___407_theta 	%line{28} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:29
#   float cgamma = cos(gamma);
	cos		___406_cgamma ___407_gamma 	%line{29} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:31
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:32
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:56
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:57
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:60
#   color xyz = xyY_to_xyz(x, y, Y);
	functioncall	$const58 435 	%line{60} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:56
#   if (y != 0.0) {
	neq		$tmp294 ___407_y $const12 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{56} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl:61
#   return xyz_to_rgb(xyz[0], xyz[1], xyz[2]);
	compref		$tmp303 ___407_xyz $const7 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_sky_texture.osl"} %line{61} %argrw{"wrr"}
	compref		$tmp304 ___407_xyz $const11 	%argrw{"wrr"}
	compref		$tmp305 ___407_xyz $const10 	%argrw{"wrr"}
	functioncall	$const36 455 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:75
#   return color(3.240479 * x + -1.537150 * y + -0.498535 * z,
	mul		$tmp306 $const37 $tmp303 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{75} %argrw{"wrr"}
