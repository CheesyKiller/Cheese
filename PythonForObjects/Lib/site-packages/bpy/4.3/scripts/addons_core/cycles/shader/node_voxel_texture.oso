...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_voxel_texture.oso
...
local	matrix	___363_tfm	%read{8,8} %write{6,6} %derivs
...
code Vector
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:11
#                           point Vector = P,
	assign		Vector P 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{11} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:15
#   point p = Vector;
	assign		p Vector 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{15} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:16
#   if (use_mapping) {
	if		use_mapping 4 9 	%line{16} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:17
#     p = transform(mapping, p);
	transform	p mapping p 	%line{17} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:20
#     p = transform("object", Vector);
	functioncall	$const2 6 	%line{20} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	p $const3 $const1 Vector 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:22
#     if (getattribute("geom:generated_transform", tfm))
	getattribute	$tmp1 $const4 ___363_tfm 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{22} %argrw{"wrw"}
	if		$tmp1 9 9 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:23
#       p = transform(tfm, p);
	transform	p ___363_tfm p 	%line{23} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:25
#   if (p[0] < 0.0 || p[1] < 0.0 || p[2] < 0.0 || p[0] > 1.0 || p[1] > 1.0 || p[2] > 1.0) {
	compref		$tmp2 p $const5 	%line{25} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:26
#     Density = 0;
	assign		Density $const5 	%line{26} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:27
#     Color = color(0, 0, 0);
	assign		Color $const10 	%line{27} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:30
#     Color = (color)texture3d(
	texture3d	Color filename p $const11 $const12 $const13 interpolation $const14 Density 	%line{30} %argrw{"wrrrrrrrw"} %argderivs{2}
	end
