...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_float_curve.oso
...
local	float	___351_f	%read{6,49} %write{4,40}
local	int	___351_table_size	%read{23,47} %write{5,5}
local	float	___352_t0	%read{21,33} %write{19,24}
local	float	___352_dy	%read{29,29} %write{21,27}
local	int	___351_i	%read{42,59} %write{41,47}
local	float	___351_t	%read{53,61} %write{49,49}
local	float	___351_result	%read{58,63} %write{50,62}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:17
#   float c = (ValueIn - min_x) / (max_x - min_x);
	sub		$tmp1 ValueIn min_x 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl"} %line{17} %argrw{"wrr"}
	sub		$tmp2 max_x min_x 	%argrw{"wrr"}
	div		c $tmp1 $tmp2 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:19
...
#   float f = at;
	assign		___351_f c 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{50} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:51
#   int table_size = arraylength(ramp);
	arraylength	___351_table_size ramp 	%line{51} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:53
#   if ((f < 0.0 || f > 1.0) && extrapolate) {
	lt		$tmp3 ___351_f $const3 	%line{53} %argrw{"wrr"}
	neq		$tmp4 $tmp3 $const4 	%argrw{"wrr"}
	if		$tmp4 9 12 	%argrw{"r"}
	gt		$tmp5 ___351_f $const5 	%argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:55
#     if (f < 0.0) {
	lt		$tmp9 ___351_f $const3 	%line{55} %argrw{"wrr"}
	if		$tmp9 23 29 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:56
#       t0 = ramp[0];
	aref		___352_t0 ramp $const4 	%line{56} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:57
#       dy = t0 - ramp[1];
	aref		$tmp10 ramp $const1 	%line{57} %argrw{"wrr"}
	sub		___352_dy ___352_t0 $tmp10 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:58
#       f = -f;
	neg		___351_f ___351_f 	%line{58} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:61
#       t0 = ramp[table_size - 1];
	sub		$tmp11 ___351_table_size $const1 	%line{61} %argrw{"wrr"}
	aref		___352_t0 ramp $tmp11 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:62
#       dy = t0 - ramp[table_size - 2];
	sub		$tmp12 ___351_table_size $const6 	%line{62} %argrw{"wrr"}
	aref		$tmp13 ramp $tmp12 	%argrw{"wrr"}
	sub		___352_dy ___352_t0 $tmp13 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:63
#       f = f - 1.0;
	sub		___351_f ___351_f $const5 	%line{63} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:65
#     return t0 + dy * f * (table_size - 1);
	mul		$tmp14 ___352_dy ___351_f 	%line{65} %argrw{"wrr"}
	sub		$tmp15 ___351_table_size $const1 	%argrw{"wrr"}
	assign		$tmp17 $tmp15 	%argrw{"wr"}
	mul		$tmp16 $tmp14 $tmp17 	%argrw{"wrr"}
	add		ValueOut ___352_t0 $tmp16 	%argrw{"wrr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:68
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp19 c $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp18 $tmp19 $const3 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:68
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp20 ___351_table_size $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{68} %argrw{"wrr"}
	assign		$tmp21 $tmp20 	%argrw{"wr"}
	mul		___351_f $tmp18 $tmp21 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:71
#   int i = (int)f;
	assign		___351_i ___351_f 	%line{71} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:72
#   if (i < 0) {
	lt		$tmp22 ___351_i $const4 	%line{72} %argrw{"wrr"}
	if		$tmp22 45 45 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:73
#     i = 0;
	assign		___351_i $const4 	%line{73} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:75
#   if (i >= table_size) {
	ge		$tmp23 ___351_i ___351_table_size 	%line{75} %argrw{"wrr"}
	if		$tmp23 48 48 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:76
#     i = table_size - 1;
	sub		___351_i ___351_table_size $const1 	%line{76} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:78
#   float t = f - (float)i;
	assign		$tmp24 ___351_i 	%line{78} %argrw{"wr"}
	sub		___351_t ___351_f $tmp24 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:80
#   float result = ramp[i];
	aref		___351_result ramp ___351_i 	%line{80} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:82
#   if (interpolate && t > 0.0) {
	neq		$tmp25 $const1 $const4 	%line{82} %argrw{"wrr"}
	if		$tmp25 56 56 	%argrw{"r"}
	gt		$tmp26 ___351_t $const3 	%argrw{"wrr"}
	neq		$tmp27 $tmp26 $const4 	%argrw{"wrr"}
	assign		$tmp25 $tmp27 	%argrw{"wr"}
	if		$tmp25 63 63 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:83
#     result = (1.0 - t) * result + t * ramp[i + 1];
	sub		$tmp28 $const5 ___351_t 	%line{83} %argrw{"wrr"}
	mul		$tmp29 $tmp28 ___351_result 	%argrw{"wrr"}
	add		$tmp30 ___351_i $const1 	%argrw{"wrr"}
	aref		$tmp31 ramp $tmp30 	%argrw{"wrr"}
	mul		$tmp32 ___351_t $tmp31 	%argrw{"wrr"}
	add		___351_result $tmp29 $tmp32 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:86
#   return result;
	assign		ValueOut ___351_result 	%line{86} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:21
#   ValueOut = mix(ValueIn, ValueOut, Factor);
	mix		ValueOut ValueIn ValueOut Factor 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl"} %line{21} %argrw{"wrrr"}
	end
