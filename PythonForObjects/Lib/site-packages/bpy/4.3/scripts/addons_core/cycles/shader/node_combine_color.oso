...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_combine_color.oso
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:13
#   if (color_type == "rgb" || color_type == "hsv" || color_type == "hsl")
	eq		$tmp1 color_type $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl"} %line{13} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:14
#     Color = color(color_type, Red, Green, Blue);
	color		Color color_type Red Green Blue 	%line{14} %argrw{"wrrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:16
