...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_background.oso
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_background.osl:11
#   Background = Color * Strength * background();
	closure		$tmp1 $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_background.osl"} %line{11} %argrw{"wr"}
