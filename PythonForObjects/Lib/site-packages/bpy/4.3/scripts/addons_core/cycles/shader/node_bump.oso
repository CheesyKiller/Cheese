...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_bump.oso
surface node_bump
...
code NormalIn
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:12
#                   normal NormalIn = N,
	assign		NormalIn N 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{12} %argrw{"wr"}
code NormalOut
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:18
#                   output normal NormalOut = N)
	assign		NormalOut N 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{18} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:20
#   point Ptmp = P;
	assign		Ptmp P 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{20} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:21
#   normal Normal = NormalIn;
	assign		Normal NormalIn 	%line{21} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:23
#   if (use_object_space) {
	if		use_object_space 10 10 	%line{23} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:24
...
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Ptmp $const3 $const1 Ptmp 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:25
#     Normal = normalize(transform("object", Normal));
	functioncall	$const2 9 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{25} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:261
# normal transform (string to, normal p) { return transform("common",to,p); }
	transformn	$tmp1 $const3 $const1 Normal 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{261} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:25
#     Normal = normalize(transform("object", Normal));
	normalize	Normal $tmp1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{25} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:29
#   vector dPdx = Dx(Ptmp);
	Dx		dPdx Ptmp 	%line{29} %argrw{"wr"} %argderivs{1}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:30
#   vector dPdy = Dy(Ptmp);
	Dy		dPdy Ptmp 	%line{30} %argrw{"wr"} %argderivs{1}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:32
#   vector Rx = cross(dPdy, Normal);
	cross		Rx dPdy Normal 	%line{32} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:33
#   vector Ry = cross(Normal, dPdx);
	cross		Ry Normal dPdx 	%line{33} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:36
#   float det = dot(dPdx, Rx);
	dot		det dPdx Rx 	%line{36} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:37
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:39
#   float absdet = fabs(det);
	fabs		absdet det 	%line{39} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:41
#   float strength = max(Strength, 0.0);
	max		strength Strength $const4 	%line{41} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:42
#   float dist = Distance;
	assign		dist Distance 	%line{42} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:44
#   if (invert)
	if		invert 25 25 	%line{44} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:45
#     dist *= -1.0;
	mul		dist dist $const5 	%line{45} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:48
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:49
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:51
#   if (use_object_space) {
	if		use_object_space 39 39 	%line{51} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:52
