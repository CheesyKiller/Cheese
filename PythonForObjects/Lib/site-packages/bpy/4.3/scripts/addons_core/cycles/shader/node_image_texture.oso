...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_image_texture.oso
...
code Vector
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:89
#                           point Vector = P,
	assign		Vector P 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{89} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:103
#   point p = Vector;
	assign		p Vector 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{103} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:105
#   if (use_mapping)
	if		use_mapping 4 4 	%line{105} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:106
#     p = transform(mapping, p);
	transform	p mapping p 	%line{106} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:108
#   if (projection == "flat") {
	eq		$tmp1 projection $const1 	%line{108} %argrw{"wrr"}
	if		$tmp1 78 737 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:110
#                                  p[0],
	compref		$tmp2 p $const2 	%line{110} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:111
#                                  p[1],
	compref		$tmp3 p $const3 	%line{111} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:109
#     Color = image_texture_lookup(filename,
	functioncall	$const4 78 	%line{109} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:60
#   if (is_tiled) {
	if		is_tiled 15 16 	%line{60} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:61
#     float v_i = (int)v;
	assign		$tmp4 $tmp3 	%line{61} %argrw{"wr"}
	assign		___414_v_i $tmp4 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:62
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:65
#     flip_v = 1.0 - v;
	sub		___413_flip_v $const5 $tmp3 	%line{65} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:67
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:70
#   if (ignore_alpha) {
	if		ignore_alpha 19 35 	%line{70} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:71
#     Alpha = 1.0;
	assign		Alpha $const5 	%line{71} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:73
#   else if (unassociate_alpha) {
	if		unassociate_alpha 35 35 	%line{73} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:74
#     rgb = color_unpremultiply(rgb, Alpha);
	functioncall	$const9 31 	%line{74} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp7 Alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp11 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
	if		$tmp11 35 35 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:77
#       rgb = min(rgb, 1.0);
	assign		$tmp12 $const5 	%line{77} %argrw{"wr"}
	min		___413_rgb ___413_rgb $tmp12 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:80
#   if (compress_as_srgb) {
	if		compress_as_srgb 77 77 	%line{80} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:81
#     rgb = color_srgb_to_scene_linear(rgb);
	functioncall	$const11 77 	%line{81} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp14 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		Color ___413_rgb 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:121
#   else if (projection == "box") {
	eq		$tmp31 projection $const18 	%line{121} %argrw{"wrr"}
	if		$tmp31 530 737 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:123
#     vector Nob = transform("world", "object", N);
	transformn	___420_Nob $const19 $const20 N 	%line{123} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:126
#     vector signed_Nob = Nob;
	assign		___420_signed_Nob ___420_Nob 	%line{126} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:127
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:128
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:140
#     vector weight = vector(0.0, 0.0, 0.0);
	assign		___420_weight $const21 	%line{140} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:141
#     float blend = projection_blend;
	assign		___420_blend projection_blend 	%line{141} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:142
#     float limit = 0.5 * (1.0 + blend);
	add		$tmp43 $const5 ___420_blend 	%line{142} %argrw{"wrr"}
	mul		___420_limit $const22 $tmp43 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:145
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:146
#       weight[0] = 1.0;
	compassign	___420_weight $const2 $const5 	%line{146} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:148
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:149
#       weight[1] = 1.0;
	compassign	___420_weight $const3 $const5 	%line{149} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:151
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:152
#       weight[2] = 1.0;
	compassign	___420_weight $const17 $const5 	%line{152} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:154
#     else if (blend > 0.0) {
	gt		$tmp86 ___420_blend $const10 	%line{154} %argrw{"wrr"}
	if		$tmp86 260 261 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:156
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:157
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:158
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp105 $tmp104 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp99 $tmp105 $const10 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:158
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___420_weight $const2 $tmp99 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{158} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:159
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:161
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:162
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:163
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp126 $tmp125 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp120 $tmp126 $const10 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:163
#         weight[1] = clamp((weight[1] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___420_weight $const3 $tmp120 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{163} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:164
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:166
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:167
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:168
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp147 $tmp146 $const5 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp141 $tmp147 $const10 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:168
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___420_weight $const2 $tmp141 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{168} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:169
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:173
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:174
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:175
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:180
#       weight[0] = 1.0;
	compassign	___420_weight $const2 $const5 	%line{180} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:183
#     Color = color(0.0, 0.0, 0.0);
	assign		Color $const25 	%line{183} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:184
#     Alpha = 0.0;
	assign		Alpha $const10 	%line{184} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:188
#     if (weight[0] > 0.0) {
	compref		$tmp174 ___420_weight $const2 	%line{188} %argrw{"wrr"}
	gt		$tmp175 $tmp174 $const10 	%argrw{"wrr"}
	if		$tmp175 352 352 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:189
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:190
#       Color += weight[0] * image_texture_lookup(filename,
	compref		$tmp181 ___420_weight $const2 	%line{190} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:191
#                                                 UV[0],
	compref		$tmp183 ___430_UV $const2 	%line{191} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:192
#                                                 UV[1],
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp188 ___420_tmp_alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp192 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp195 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp182 ___413_rgb 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:190
#       Color += weight[0] * image_texture_lookup(filename,
	mul		$tmp212 $tmp181 $tmp182 	%line{190} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:200
#                                                 extension);
	add		Color Color $tmp212 	%line{200} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:201
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:203
#     if (weight[1] > 0.0) {
	compref		$tmp215 ___420_weight $const3 	%line{203} %argrw{"wrr"}
	gt		$tmp216 $tmp215 $const10 	%argrw{"wrr"}
	if		$tmp216 441 441 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:204
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:205
#       Color += weight[1] * image_texture_lookup(filename,
	compref		$tmp222 ___420_weight $const3 	%line{205} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:206
#                                                 UV[0],
	compref		$tmp224 ___431_UV $const2 	%line{206} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:207
#                                                 UV[1],
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp229 ___420_tmp_alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp233 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp236 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp223 ___413_rgb 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:205
#       Color += weight[1] * image_texture_lookup(filename,
	mul		$tmp253 $tmp222 $tmp223 	%line{205} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:215
#                                                 extension);
	add		Color Color $tmp253 	%line{215} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:216
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:218
#     if (weight[2] > 0.0) {
	compref		$tmp256 ___420_weight $const17 	%line{218} %argrw{"wrr"}
	gt		$tmp257 $tmp256 $const10 	%argrw{"wrr"}
	if		$tmp257 530 530 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:219
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:220
#       Color += weight[2] * image_texture_lookup(filename,
	compref		$tmp263 ___420_weight $const17 	%line{220} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:221
#                                                 UV[0],
	compref		$tmp265 ___432_UV $const2 	%line{221} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:222
#                                                 UV[1],
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp270 ___420_tmp_alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp274 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp277 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp264 ___413_rgb 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:220
#       Color += weight[2] * image_texture_lookup(filename,
	mul		$tmp294 $tmp263 $tmp264 	%line{220} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:230
#                                                 extension);
	add		Color Color $tmp294 	%line{230} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:231
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:234
#   else if (projection == "sphere") {
	eq		$tmp297 projection $const26 	%line{234} %argrw{"wrr"}
	if		$tmp297 635 737 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:235
#     point projected = map_to_sphere(texco_remap_square(p));
	functioncall	$const27 535 	%line{235} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:10
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:29
#   float len = length(dir);
	length		___408_len $tmp298 	%line{29} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:31
#   if (len > 0.0) {
	gt		$tmp301 ___408_len $const10 	%line{31} %argrw{"wrr"}
	if		$tmp301 560 562 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:32
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:33
#       u = 0.0; /* Otherwise domain error. */
	assign		___408_u $const10 	%line{33} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:36
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:38
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:41
#     v = u = 0.0; /* To avoid un-initialized variables. */
	assign		___408_u $const10 	%line{41} %argrw{"wr"}
	assign		___408_v ___408_u 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:43
#   return point(u, v, 0.0);
	point		___433_projected ___408_u ___408_v $const10 	%line{43} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:237
#                                  projected[0],
	compref		$tmp317 ___433_projected $const2 	%line{237} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:238
#                                  projected[1],
	compref		$tmp318 ___433_projected $const3 	%line{238} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:236
#     Color = image_texture_lookup(filename,
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp322 Alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp326 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp329 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
#   return rgb;
	assign		Color ___413_rgb 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:248
#   else if (projection == "tube") {
	eq		$tmp346 projection $const31 	%line{248} %argrw{"wrr"}
	if		$tmp346 737 737 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:249
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:16
#   v = (dir[2] + 1.0) * 0.5;
	compref		$tmp350 $tmp347 $const17 	%line{16} %argrw{"wrr"}
	add		$tmp351 $tmp350 $const5 	%argrw{"wrr"}
	mul		___405_v $tmp351 $const22 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:17
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:18
#   if (len > 0.0) {
	gt		$tmp359 ___405_len $const10 	%line{18} %argrw{"wrr"}
	if		$tmp359 662 664 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:19
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:22
#     v = u = 0.0; /* To avoid un-initialized variables. */
	assign		___405_u $const10 	%line{22} %argrw{"wr"}
	assign		___405_v ___405_u 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:24
#   return point(u, v, 0.0);
	point		___434_projected ___405_u ___405_v $const10 	%line{24} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:251
#                                  projected[0],
	compref		$tmp367 ___434_projected $const2 	%line{251} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:252
#                                  projected[1],
	compref		$tmp368 ___434_projected $const3 	%line{252} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:250
#     Color = image_texture_lookup(filename,
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp372 Alpha $const5 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp376 is_float $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp379 ___413_rgb $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
