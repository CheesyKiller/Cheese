...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_fresnel.oso
shader node_fresnel
...
code Normal
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:8
# shader node_fresnel(float IOR = 1.45, normal Normal = N, output float Fac = 0.0)
	assign		Normal N 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl"} %line{8} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:10
#   float f = max(IOR, 1e-5);
	max		f IOR $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl"} %line{10} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:11
#   float eta = backfacing() ? 1.0 / f : f;
	backfacing	$tmp1 	%line{11} %argrw{"w"}
	if		$tmp1 5 6 	%argrw{"r"}
	div		eta $const2 f 	%argrw{"wrr"}
	assign		eta f 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:12
#   float cosi = dot(I, Normal);
	dot		cosi I Normal 	%line{12} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:13
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:16
#   if (g > 0) {
	gt		$tmp5 ___344_g $const5 	%line{16} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:18
#     float A = (g - c) / (g + c);
	sub		$tmp6 ___344_g ___344_c 	%line{18} %argrw{"wrr"}
	add		$tmp7 ___344_g ___344_c 	%argrw{"wrr"}
	div		___345_A $tmp6 $tmp7 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:19
#     float B = (c * (g + c) - 1) / (c * (g - c) + 1);
	add		$tmp8 ___344_g ___344_c 	%line{19} %argrw{"wrr"}
...
#     result = 0.5 * A * A * (1 + B * B);
	mul		$tmp14 $const6 ___345_A 	%line{20} %argrw{"wrr"}
...
#     result = 1.0; /* TIR (no refracted component) */
	assign		___344_result $const2 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:26
#   return result;
