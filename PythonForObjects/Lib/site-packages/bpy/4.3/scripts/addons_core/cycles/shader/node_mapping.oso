...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_mapping.oso
shader node_mapping
...
local	float	___363_cx	%read{24,217} %write{4,177}
local	float	___363_cy	%read{16,217} %write{6,179}
local	float	___363_cz	%read{16,214} %write{8,181}
local	float	___363_sx	%read{22,214} %write{10,183}
local	float	___363_sy	%read{20,212} %write{12,185}
local	float	___363_sz	%read{18,213} %write{14,187}
local	matrix	___363_mat	%read{46,219} %write{15,218}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:45
#   if (mapping_type == "point") {
	eq		$tmp1 mapping_type $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl"} %line{45} %argrw{"wrr"}
	if		$tmp1 50 247 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:46
#     VectorOut = transform(euler_to_mat(Rotation), (VectorIn * Scale)) + Location;
	functioncall	$const2 47 	%line{46} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:16
#   float cx = cos(euler[0]);
	compref		$tmp4 Rotation $const3 	%line{16} %argrw{"wrr"}
	cos		___363_cx $tmp4 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:17
#   float cy = cos(euler[1]);
	compref		$tmp5 Rotation $const4 	%line{17} %argrw{"wrr"}
	cos		___363_cy $tmp5 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:18
#   float cz = cos(euler[2]);
	compref		$tmp6 Rotation $const5 	%line{18} %argrw{"wrr"}
	cos		___363_cz $tmp6 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:19
#   float sx = sin(euler[0]);
	compref		$tmp7 Rotation $const3 	%line{19} %argrw{"wrr"}
	sin		___363_sx $tmp7 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:20
#   float sy = sin(euler[1]);
	compref		$tmp8 Rotation $const4 	%line{20} %argrw{"wrr"}
	sin		___363_sy $tmp8 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:21
#   float sz = sin(euler[2]);
	compref		$tmp9 Rotation $const5 	%line{21} %argrw{"wrr"}
	sin		___363_sz $tmp9 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:23
#   matrix mat = matrix(1.0);
	assign		___363_mat $const6 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:24
#   mat[0][0] = cy * cz;
	mul		$tmp10 ___363_cy ___363_cz 	%line{24} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const3 $tmp10 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:25
#   mat[0][1] = cy * sz;
	mul		$tmp11 ___363_cy ___363_sz 	%line{25} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const4 $tmp11 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:26
#   mat[0][2] = -sy;
	neg		$tmp12 ___363_sy 	%line{26} %argrw{"wr"}
	mxcompassign	___363_mat $const3 $const5 $tmp12 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:28
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp13 ___363_sy ___363_sx 	%line{28} %argrw{"wrr"}
	mul		$tmp14 $tmp13 ___363_cz 	%argrw{"wrr"}
	mul		$tmp15 ___363_cx ___363_sz 	%argrw{"wrr"}
	sub		$tmp16 $tmp14 $tmp15 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const3 $tmp16 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:29
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp17 ___363_sy ___363_sx 	%line{29} %argrw{"wrr"}
	mul		$tmp18 $tmp17 ___363_sz 	%argrw{"wrr"}
	mul		$tmp19 ___363_cx ___363_cz 	%argrw{"wrr"}
	add		$tmp20 $tmp18 $tmp19 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const4 $tmp20 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:30
#   mat[1][2] = cy * sx;
	mul		$tmp21 ___363_cy ___363_sx 	%line{30} %argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const5 $tmp21 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:32
#   mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp22 ___363_sy ___363_cx 	%line{32} %argrw{"wrr"}
	mul		$tmp23 $tmp22 ___363_cz 	%argrw{"wrr"}
	mul		$tmp24 ___363_sx ___363_sz 	%argrw{"wrr"}
	add		$tmp25 $tmp23 $tmp24 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const3 $tmp25 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:33
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp26 ___363_sy ___363_cx 	%line{33} %argrw{"wrr"}
	mul		$tmp27 $tmp26 ___363_sz 	%argrw{"wrr"}
	mul		$tmp28 ___363_sx ___363_cz 	%argrw{"wrr"}
	sub		$tmp29 $tmp27 $tmp28 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const4 $tmp29 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:34
#   mat[2][2] = cy * cx;
	mul		$tmp30 ___363_cy ___363_cx 	%line{34} %argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const5 $tmp30 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:35
#   return mat;
	assign		$tmp3 ___363_mat 	%line{35} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:46
#     VectorOut = transform(euler_to_mat(Rotation), (VectorIn * Scale)) + Location;
	mul		$tmp31 VectorIn Scale 	%line{46} %argrw{"wrr"}
	transform	$tmp2 $tmp3 $tmp31 	%argrw{"wrr"}
	add		VectorOut $tmp2 Location 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:48
#   else if (mapping_type == "texture") {
	eq		$tmp32 mapping_type $const7 	%line{48} %argrw{"wrr"}
	if		$tmp32 124 247 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:49
...
#   float cx = cos(euler[0]);
	...
	cos		___363_cx $tmp36 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:17
#   float cy = cos(euler[1]);
	compref		$tmp37 Rotation $const4 	%line{17} %argrw{"wrr"}
	cos		___363_cy $tmp37 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:18
#   float cz = cos(euler[2]);
	compref		$tmp38 Rotation $const5 	%line{18} %argrw{"wrr"}
	cos		___363_cz $tmp38 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:19
#   float sx = sin(euler[0]);
	compref		$tmp39 Rotation $const3 	%line{19} %argrw{"wrr"}
	sin		___363_sx $tmp39 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:20
#   float sy = sin(euler[1]);
	compref		$tmp40 Rotation $const4 	%line{20} %argrw{"wrr"}
	sin		___363_sy $tmp40 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:21
#   float sz = sin(euler[2]);
	compref		$tmp41 Rotation $const5 	%line{21} %argrw{"wrr"}
	sin		___363_sz $tmp41 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:23
#   matrix mat = matrix(1.0);
	assign		___363_mat $const6 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:24
#   mat[0][0] = cy * cz;
	mul		$tmp42 ___363_cy ___363_cz 	%line{24} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const3 $tmp42 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:25
#   mat[0][1] = cy * sz;
	mul		$tmp43 ___363_cy ___363_sz 	%line{25} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const4 $tmp43 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:26
#   mat[0][2] = -sy;
	neg		$tmp44 ___363_sy 	%line{26} %argrw{"wr"}
	mxcompassign	___363_mat $const3 $const5 $tmp44 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:28
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp45 ___363_sy ___363_sx 	%line{28} %argrw{"wrr"}
	mul		$tmp46 $tmp45 ___363_cz 	%argrw{"wrr"}
	mul		$tmp47 ___363_cx ___363_sz 	%argrw{"wrr"}
	sub		$tmp48 $tmp46 $tmp47 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const3 $tmp48 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:29
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp49 ___363_sy ___363_sx 	%line{29} %argrw{"wrr"}
	mul		$tmp50 $tmp49 ___363_sz 	%argrw{"wrr"}
	mul		$tmp51 ___363_cx ___363_cz 	%argrw{"wrr"}
	add		$tmp52 $tmp50 $tmp51 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const4 $tmp52 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:30
#   mat[1][2] = cy * sx;
	mul		$tmp53 ___363_cy ___363_sx 	%line{30} %argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const5 $tmp53 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:32
#   mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp54 ___363_sy ___363_cx 	%line{32} %argrw{"wrr"}
	mul		$tmp55 $tmp54 ___363_cz 	%argrw{"wrr"}
	mul		$tmp56 ___363_sx ___363_sz 	%argrw{"wrr"}
	add		$tmp57 $tmp55 $tmp56 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const3 $tmp57 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:33
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp58 ___363_sy ___363_cx 	%line{33} %argrw{"wrr"}
	mul		$tmp59 $tmp58 ___363_sz 	%argrw{"wrr"}
	mul		$tmp60 ___363_sx ___363_cz 	%argrw{"wrr"}
	sub		$tmp61 $tmp59 $tmp60 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const4 $tmp61 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:34
#   mat[2][2] = cy * cx;
	mul		$tmp62 ___363_cy ___363_cx 	%line{34} %argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const5 $tmp62 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:35
#   return mat;
	assign		$tmp35 ___363_mat 	%line{35} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:49
#     VectorOut = safe_divide(transform(transpose(euler_to_mat(Rotation)), (VectorIn - Location)),
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:9
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:10
#                (b[1] != 0.0) ? a[1] / b[1] : 0.0,
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:11
#                (b[2] != 0.0) ? a[2] / b[2] : 0.0);
...
#                (b[2] != 0.0) ? a[2] / b[2] : 0.0);
	return	%line{11}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:52
#   else if (mapping_type == "vector") {
	eq		$tmp79 mapping_type $const10 	%line{52} %argrw{"wrr"}
	if		$tmp79 173 247 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:53
...
#   float cx = cos(euler[0]);
	...
	cos		___363_cx $tmp81 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:17
#   float cy = cos(euler[1]);
	compref		$tmp82 Rotation $const4 	%line{17} %argrw{"wrr"}
	cos		___363_cy $tmp82 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:18
#   float cz = cos(euler[2]);
	compref		$tmp83 Rotation $const5 	%line{18} %argrw{"wrr"}
	cos		___363_cz $tmp83 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:19
#   float sx = sin(euler[0]);
	compref		$tmp84 Rotation $const3 	%line{19} %argrw{"wrr"}
	sin		___363_sx $tmp84 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:20
#   float sy = sin(euler[1]);
	compref		$tmp85 Rotation $const4 	%line{20} %argrw{"wrr"}
	sin		___363_sy $tmp85 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:21
#   float sz = sin(euler[2]);
	compref		$tmp86 Rotation $const5 	%line{21} %argrw{"wrr"}
	sin		___363_sz $tmp86 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:23
#   matrix mat = matrix(1.0);
	assign		___363_mat $const6 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:24
#   mat[0][0] = cy * cz;
	mul		$tmp87 ___363_cy ___363_cz 	%line{24} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const3 $tmp87 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:25
#   mat[0][1] = cy * sz;
	mul		$tmp88 ___363_cy ___363_sz 	%line{25} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const4 $tmp88 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:26
#   mat[0][2] = -sy;
	neg		$tmp89 ___363_sy 	%line{26} %argrw{"wr"}
	mxcompassign	___363_mat $const3 $const5 $tmp89 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:28
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp90 ___363_sy ___363_sx 	%line{28} %argrw{"wrr"}
	mul		$tmp91 $tmp90 ___363_cz 	%argrw{"wrr"}
	mul		$tmp92 ___363_cx ___363_sz 	%argrw{"wrr"}
	sub		$tmp93 $tmp91 $tmp92 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const3 $tmp93 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:29
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp94 ___363_sy ___363_sx 	%line{29} %argrw{"wrr"}
	mul		$tmp95 $tmp94 ___363_sz 	%argrw{"wrr"}
	mul		$tmp96 ___363_cx ___363_cz 	%argrw{"wrr"}
	add		$tmp97 $tmp95 $tmp96 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const4 $tmp97 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:30
#   mat[1][2] = cy * sx;
	mul		$tmp98 ___363_cy ___363_sx 	%line{30} %argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const5 $tmp98 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:32
#   mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp99 ___363_sy ___363_cx 	%line{32} %argrw{"wrr"}
	mul		$tmp100 $tmp99 ___363_cz 	%argrw{"wrr"}
	mul		$tmp101 ___363_sx ___363_sz 	%argrw{"wrr"}
	add		$tmp102 $tmp100 $tmp101 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const3 $tmp102 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:33
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp103 ___363_sy ___363_cx 	%line{33} %argrw{"wrr"}
	mul		$tmp104 $tmp103 ___363_sz 	%argrw{"wrr"}
	mul		$tmp105 ___363_sx ___363_cz 	%argrw{"wrr"}
	sub		$tmp106 $tmp104 $tmp105 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const4 $tmp106 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:34
#   mat[2][2] = cy * cx;
	mul		$tmp107 ___363_cy ___363_cx 	%line{34} %argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const5 $tmp107 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:35
#   return mat;
	assign		$tmp80 ___363_mat 	%line{35} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:53
#     VectorOut = transform(euler_to_mat(Rotation), (VectorIn * Scale));
	mul		$tmp108 VectorIn Scale 	%line{53} %argrw{"wrr"}
	transform	VectorOut $tmp80 $tmp108 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:55
#   else if (mapping_type == "normal") {
	eq		$tmp109 mapping_type $const11 	%line{55} %argrw{"wrr"}
	if		$tmp109 246 247 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:56
...
#   float cx = cos(euler[0]);
	...
	cos		___363_cx $tmp112 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:17
#   float cy = cos(euler[1]);
	compref		$tmp113 Rotation $const4 	%line{17} %argrw{"wrr"}
	cos		___363_cy $tmp113 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:18
#   float cz = cos(euler[2]);
	compref		$tmp114 Rotation $const5 	%line{18} %argrw{"wrr"}
	cos		___363_cz $tmp114 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:19
#   float sx = sin(euler[0]);
	compref		$tmp115 Rotation $const3 	%line{19} %argrw{"wrr"}
	sin		___363_sx $tmp115 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:20
#   float sy = sin(euler[1]);
	compref		$tmp116 Rotation $const4 	%line{20} %argrw{"wrr"}
	sin		___363_sy $tmp116 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:21
#   float sz = sin(euler[2]);
	compref		$tmp117 Rotation $const5 	%line{21} %argrw{"wrr"}
	sin		___363_sz $tmp117 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:23
#   matrix mat = matrix(1.0);
	assign		___363_mat $const6 	%line{23} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:24
#   mat[0][0] = cy * cz;
	mul		$tmp118 ___363_cy ___363_cz 	%line{24} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const3 $tmp118 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:25
#   mat[0][1] = cy * sz;
	mul		$tmp119 ___363_cy ___363_sz 	%line{25} %argrw{"wrr"}
	mxcompassign	___363_mat $const3 $const4 $tmp119 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:26
#   mat[0][2] = -sy;
	neg		$tmp120 ___363_sy 	%line{26} %argrw{"wr"}
	mxcompassign	___363_mat $const3 $const5 $tmp120 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:28
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp121 ___363_sy ___363_sx 	%line{28} %argrw{"wrr"}
	mul		$tmp122 $tmp121 ___363_cz 	%argrw{"wrr"}
	mul		$tmp123 ___363_cx ___363_sz 	%argrw{"wrr"}
	sub		$tmp124 $tmp122 $tmp123 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const3 $tmp124 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:29
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp125 ___363_sy ___363_sx 	%line{29} %argrw{"wrr"}
	mul		$tmp126 $tmp125 ___363_sz 	%argrw{"wrr"}
	mul		$tmp127 ___363_cx ___363_cz 	%argrw{"wrr"}
	add		$tmp128 $tmp126 $tmp127 	%argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const4 $tmp128 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:30
#   mat[1][2] = cy * sx;
	mul		$tmp129 ___363_cy ___363_sx 	%line{30} %argrw{"wrr"}
	mxcompassign	___363_mat $const4 $const5 $tmp129 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:32
#   mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp130 ___363_sy ___363_cx 	%line{32} %argrw{"wrr"}
	mul		$tmp131 $tmp130 ___363_cz 	%argrw{"wrr"}
	mul		$tmp132 ___363_sx ___363_sz 	%argrw{"wrr"}
	add		$tmp133 $tmp131 $tmp132 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const3 $tmp133 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:33
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp134 ___363_sy ___363_cx 	%line{33} %argrw{"wrr"}
	mul		$tmp135 $tmp134 ___363_sz 	%argrw{"wrr"}
	mul		$tmp136 ___363_sx ___363_cz 	%argrw{"wrr"}
	sub		$tmp137 $tmp135 $tmp136 	%argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const4 $tmp137 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:34
#   mat[2][2] = cy * cx;
	mul		$tmp138 ___363_cy ___363_cx 	%line{34} %argrw{"wrr"}
	mxcompassign	___363_mat $const5 $const5 $tmp138 	%argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:35
#   return mat;
	assign		$tmp111 ___363_mat 	%line{35} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:56
#     VectorOut = normalize((vector)transform(euler_to_mat(Rotation), safe_divide(VectorIn, Scale)));
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:59
