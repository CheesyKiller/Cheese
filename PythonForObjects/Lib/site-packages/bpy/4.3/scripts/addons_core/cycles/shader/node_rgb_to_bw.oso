...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.oso
...
const	float	$const2	0.212599993		%read{1,1} %write{2147483647,-1}
temp	float	$tmp2	%read{4,4} %write{1,1}
const	int	$const3	1		%read{2,2} %write{2147483647,-1}
temp	float	$tmp3	%read{3,3} %write{2,2}
const	float	$const4	0.715200007		%read{3,3} %write{2147483647,-1}
temp	float	$tmp4	%read{4,4} %write{3,3}
temp	float	$tmp5	%read{7,7} %write{4,4}
const	int	$const5	2		%read{5,5} %write{2147483647,-1}
temp	float	$tmp6	%read{6,6} %write{5,5}
const	float	$const6	0.0722000003		%read{6,6} %write{2147483647,-1}
temp	float	$tmp7	%read{7,7} %write{6,6}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.osl:9
#   Val = Color[0] * 0.2126 + Color[1] * 0.7152 + Color[2] * 0.0722;
	compref		$tmp1 Color $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.osl"} %line{9} %argrw{"wrr"}
