...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_glass_bsdf.oso
...
code Normal
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:12
#                        normal Normal = N,
	assign		Normal N 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl"} %line{12} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:15
#   color base_color = max(Color, color(0.0));
	max		base_color Color $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl"} %line{15} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:16
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:17
#   r2 = r2 * r2;
	mul		r2 r2 r2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl"} %line{17} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:18
#   float eta = max(IOR, 1e-5);
	max		eta IOR $const5 	%line{18} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:19
#   eta = backfacing() ? 1.0 / eta : eta;
	backfacing	$tmp3 	%line{19} %argrw{"w"}
	if		$tmp3 10 10 	%argrw{"r"}
	div		eta $const3 eta 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:20
...
#   float f0 = (eta - 1.0) / (eta + 1.0);
	sub		$tmp5 eta $const3 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{42} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:20
#   color F0 = F0_from_ior(eta);
	assign		F0 $tmp4 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl"} %line{20} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:21
#   color F90 = color(1.0);
	assign		F90 $const7 	%line{21} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:24
#       Normal, vector(0.0), base_color, base_color, r2, r2, F0, F90, -eta, distribution);
	neg		$tmp8 eta 	%line{24} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_glass_bsdf.osl:23
