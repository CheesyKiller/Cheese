...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_map_range.oso
...
local	float	___363_t	%read{38,62} %write{37,57}
local	float	___364_Factor	%read{11,69} %write{2,67}
...
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:27
#   if (FromMax != FromMin) {
	neq		$tmp1 FromMax FromMin 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl"} %line{27} %argrw{"wrr"}
	if		$tmp1 71 71 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:28
#     float Factor = Value;
	assign		___364_Factor Value 	%line{28} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:29
#     if (range_type == "stepped") {
	eq		$tmp2 range_type $const1 	%line{29} %argrw{"wrr"}
	if		$tmp2 15 68 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:30
#       Factor = (Value - FromMin) / (FromMax - FromMin);
	sub		$tmp3 Value FromMin 	%line{30} %argrw{"wrr"}
	sub		$tmp4 FromMax FromMin 	%argrw{"wrr"}
	div		___364_Factor $tmp3 $tmp4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:31
#       Factor = (Steps > 0) ? floor(Factor * (Steps + 1.0)) / Steps : 0.0;
	...
	mul		$tmp8 ___364_Factor $tmp7 	%argrw{"wrr"}
	floor		$tmp6 $tmp8 	%argrw{"wr"}
	div		___364_Factor $tmp6 Steps 	%argrw{"wrr"}
	assign		___364_Factor $const4 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:33
#     else if (range_type == "smoothstep") {
	eq		$tmp9 range_type $const5 	%line{33} %argrw{"wrr"}
	if		$tmp9 22 68 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:34
#       Factor = (FromMin > FromMax) ? 1.0 - smoothstep(FromMax, FromMin, Value) :
	...
	sub		___364_Factor $const3 $tmp11 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:35
#                                      smoothstep(FromMin, FromMax, Value);
	smoothstep	___364_Factor FromMin FromMax Value 	%line{35} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:37
#     else if (range_type == "smootherstep") {
	eq		$tmp12 range_type $const6 	%line{37} %argrw{"wrr"}
	if		$tmp12 65 68 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:38
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:14
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:9
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp19 $tmp15 $const3 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___363_t $tmp19 $const4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:15
#   return t * t * t * (t * (t * 6.0 - 15.0) + 10.0);
	mul		$tmp20 ___363_t ___363_t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl"} %line{15} %argrw{"wrr"}
	mul		$tmp21 $tmp20 ___363_t 	%argrw{"wrr"}
	mul		$tmp22 ___363_t $const9 	%argrw{"wrr"}
	sub		$tmp23 $tmp22 $const10 	%argrw{"wrr"}
	mul		$tmp24 ___363_t $tmp23 	%argrw{"wrr"}
	add		$tmp25 $tmp24 $const11 	%argrw{"wrr"}
	mul		$tmp14 $tmp21 $tmp25 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:38
#       Factor = (FromMin > FromMax) ? 1.0 - smootherstep(FromMax, FromMin, Value) :
	sub		___364_Factor $const3 $tmp14 	%line{38} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:39
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp30 $tmp26 $const3 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___363_t $tmp30 $const4 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:15
#   return t * t * t * (t * (t * 6.0 - 15.0) + 10.0);
	mul		$tmp31 ___363_t ___363_t 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl"} %line{15} %argrw{"wrr"}
	mul		$tmp32 $tmp31 ___363_t 	%argrw{"wrr"}
	mul		$tmp33 ___363_t $const9 	%argrw{"wrr"}
	sub		$tmp34 $tmp33 $const10 	%argrw{"wrr"}
	mul		$tmp35 ___363_t $tmp34 	%argrw{"wrr"}
	add		$tmp36 $tmp35 $const11 	%argrw{"wrr"}
	mul		___364_Factor $tmp32 $tmp36 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:42
#       Factor = (Value - FromMin) / (FromMax - FromMin);
	sub		$tmp37 Value FromMin 	%line{42} %argrw{"wrr"}
	sub		$tmp38 FromMax FromMin 	%argrw{"wrr"}
	div		___364_Factor $tmp37 $tmp38 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_map_range.osl:44
#     Result = ToMin + Factor * (ToMax - ToMin);
	sub		$tmp39 ToMax ToMin 	%line{44} %argrw{"wrr"}
	mul		$tmp40 ___364_Factor $tmp39 	%argrw{"wrr"}
