...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_gabor_texture.oso
...
code Vector
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:282
#                           vector3 Vector = P,
	assign		Vector P 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{282} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:292
#   vector3 coordinates = Vector;
	assign		coordinates Vector 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{292} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:293
#   if (use_mapping) {
	if		use_mapping 4 4 	%line{293} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:294
#     coordinates = transform(mapping, coordinates);
	transform	coordinates mapping coordinates 	%line{294} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:297
#   vector3 scaled_coordinates = coordinates * Scale;
	mul		scaled_coordinates coordinates Scale 	%line{297} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:298
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2 Anisotropy $const1 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp1 $tmp2 $const2 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:298
#   float isotropy = 1.0 - clamp(Anisotropy, 0.0, 1.0);
	sub		isotropy $const1 $tmp1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{298} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:299
#   float frequency = max(0.001, Frequency);
	max		frequency $const4 Frequency 	%line{299} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:301
#   vector2 phasor = vector2(0.0, 0.0);
	assign		phasor.x $const2 	%line{301} %argrw{"wr"}
	assign		phasor.y $const2 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:302
#   float standard_deviation = 1.0;
	assign		standard_deviation $const1 	%line{302} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:303
#   if (type == "2D") {
	eq		$tmp3 type $const5 	%line{303} %argrw{"wrr"}
	if		$tmp3 157 350 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:305
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:304
#     phasor = compute_2d_gabor_noise(
	functioncall	$const8 147 	%line{304} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:149
...
#     return vector2 (floor(a.x), floor(a.y));
	floor		___497_cell_position.x $tmp4.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{157} %argrw{"wr"}
	floor		___497_cell_position.y $tmp4.y 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const10 24 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___497_local_position.x $tmp4.x ___497_cell_position.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___497_local_position.y $tmp4.y ___497_cell_position.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:152
#   vector2 sum = vector2(0.0, 0.0);
	assign		___497_sum.x $const2 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{152} %argrw{"wr"}
	assign		___497_sum.y $const2 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:153
#   for (int j = -1; j <= 1; j++) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:154
#     for (int i = -1; i <= 1; i++) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:155
...
#     return vector2(a.x + b.x, a.y + b.y);
	add		___501_current_cell_position.x ___497_cell_position.x ___501_cell_offset.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___501_current_cell_position.y ___497_cell_position.y ___501_cell_offset.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const10 42 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___501_position_in_cell_space.x ___497_local_position.x ___501_cell_offset.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___501_position_in_cell_space.y ___497_local_position.y ___501_cell_offset.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:158
#       sum += compute_2d_gabor_noise_cell(
	functioncall	$const13 138 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{158} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:116
#   vector2 noise = vector2(0.0, 0.0);
	assign		___494_noise.x $const2 	%line{116} %argrw{"wr"}
	assign		___494_noise.y $const2 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:117
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:119
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:120
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:121
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:127
...
#   return hashnoise(k);
	hashnoise	$tmp20 ___496_seed_for_orientation 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{25} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:127
#     float random_orientation = hash_vector3_to_float(seed_for_orientation) * M_PI;
	mul		___496_random_orientation $tmp20 $const18 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{127} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:128
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:130
...
#   return vector2(hash_vector3_to_float(vector3(k.x, k.y, k.z)),
	compref		$tmp23 ___496_seed_for_kernel_center $const6 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{117} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const10 81 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___496_position_in_kernel_space.x ___501_position_in_cell_space.x ___496_kernel_center.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___496_position_in_kernel_space.y ___501_position_in_cell_space.y ___496_kernel_center.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:135
#     float weight = hash_vector3_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	functioncall	$const17 83 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{135} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:25
#   return hashnoise(k);
	hashnoise	$tmp30 ___496_seed_for_weight 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{25} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:135
#     float weight = hash_vector3_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	lt		$tmp31 $tmp30 $const20 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{135} %argrw{"wrr"}
	if		$tmp31 86 87 	%argrw{"r"}
	assign		___496_weight $const21 	%argrw{"wr"}
	assign		___496_weight $const1 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:137
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:65
...
#     return (a.x * b.x + a.y * b.y);
	mul		$tmp34 ___496_position_in_kernel_space.x ___496_position_in_kernel_space.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{187} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:66
#   if (distance_squared >= 1.0) {
	ge		$tmp36 ___491_distance_squared $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{66} %argrw{"wrr"}
	if		$tmp36 97 97 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:67
#     return vector2(0.0, 0.0);
	assign		$tmp33.x $const2 	%line{67} %argrw{"wr"}
	assign		$tmp33.y $const2 	%argrw{"wr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:70
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:71
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:72
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:74
...
#     return b * vector2(a, a);
	assign		$tmp42.x frequency 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp42.y frequency 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 112 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___491_frequency_vector.x $tmp41.x $tmp42.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___491_frequency_vector.y $tmp41.y $tmp42.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:75
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
	functioncall	$const23 116 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{75} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:187
#     return (a.x * b.x + a.y * b.y);
	mul		$tmp44 ___496_position_in_kernel_space.x ___491_frequency_vector.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{187} %argrw{"wrr"}
	mul		$tmp45 ___496_position_in_kernel_space.y ___491_frequency_vector.y 	%argrw{"wrr"}
	add		$tmp43 $tmp44 $tmp45 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:75
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
	mul		___491_angle $const26 $tmp43 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{75} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:76
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp46.x ___491_windowed_gaussian_envelope 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp46.y ___491_windowed_gaussian_envelope 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 125 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp33.x ___491_phasor.x $tmp46.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp33.y ___491_phasor.y $tmp46.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 131 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp47.x ___496_weight 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp32.x $tmp33.x $tmp47.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp32.y $tmp33.y $tmp47.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const12 134 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___494_noise.x ___494_noise.x $tmp32.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___494_noise.y ___494_noise.y $tmp32.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:117
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
	add		___495_i ___495_i $const7 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{117} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:139
#   return noise;
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___497_sum.x ___497_sum.x $tmp9.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___497_sum.y ___497_sum.y $tmp9.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:154
#     for (int i = -1; i <= 1; i++) {
	assign		$tmp48 ___500_i 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{154} %argrw{"wr"}
	add		___500_i ___500_i $const7 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:153
#   for (int j = -1; j <= 1; j++) {
	assign		$tmp49 ___498_j 	%line{153} %argrw{"wr"}
	add		___498_j ___498_j $const7 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:163
#   return sum;
	assign		phasor.x ___497_sum.x 	%line{163} %argrw{"wr"}
	assign		phasor.y ___497_sum.y 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:306
#     standard_deviation = compute_2d_gabor_standard_deviation(frequency);
	functioncall	$const27 157 	%line{306} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:101
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:102
#   float second_moment = 0.5;
	assign		___493_second_moment $const20 	%line{102} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:103
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:308
#   else if (type == "3D") {
	eq		$tmp56 type $const31 	%line{308} %argrw{"wrr"}
	if		$tmp56 349 350 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:309
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:310
#     phasor = compute_3d_gabor_noise(scaled_coordinates, frequency, isotropy, orientation);
	functioncall	$const32 338 	%line{310} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:260
#   vector3 cell_position = floor(coordinates);
	floor		___510_cell_position scaled_coordinates 	%line{260} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:261
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:263
#   vector2 sum = vector2(0.0, 0.0);
	assign		___510_sum.x $const2 	%line{263} %argrw{"wr"}
	assign		___510_sum.y $const2 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:264
#   for (int k = -1; k <= 1; k++) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:265
#     for (int j = -1; j <= 1; j++) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:266
#       for (int i = -1; i <= 1; i++) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:267
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:268
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:269
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:270
#         sum += compute_3d_gabor_noise_cell(
	functioncall	$const33 327 	%line{270} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:233
#   vector2 noise = vector2(0.0, 0.0);
	assign		___507_noise.x $const2 	%line{233} %argrw{"wr"}
	assign		___507_noise.y $const2 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:234
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:236
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:237
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:238
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:240
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:207
#   if (isotropy == 0.0) {
	eq		$tmp75 isotropy $const2 	%line{207} %argrw{"wrr"}
	if		$tmp75 213 213 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:208
#     return orientation;
	assign		___509_orientation ___519_orientation 	%line{208} %argrw{"wr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:212
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:213
#   float azimuth = sign(orientation.y) *
	compref		$tmp78 ___519_orientation $const7 	%line{213} %argrw{"wrr"}
	sign		$tmp77 $tmp78 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:214
...
#     return hypot (a.x, a.y);
	functioncall	$const36 226 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{192} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:101
# float hypot (float a, float b) { return sqrt (a*a + b*b); }
	mul		$tmp83 $tmp82.x $tmp82.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{101} %argrw{"wrr"}
	mul		$tmp84 $tmp82.y $tmp82.y 	%argrw{"wrr"}
	add		$tmp85 $tmp83 $tmp84 	%argrw{"wrr"}
	sqrt		$tmp81 $tmp85 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:214
#                   acos(orientation.x / length(vector2(orientation.x, orientation.y)));
	div		$tmp86 $tmp80 $tmp81 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{214} %argrw{"wrr"}
	acos		$tmp79 $tmp86 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:213
#   float azimuth = sign(orientation.y) *
	mul		___505_azimuth $tmp77 $tmp79 	%line{213} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:220
...
#   return vector2(hash_vector4_to_float(vector4(k.x, k.y, k.z, k.w)),
	assign		$tmp88.x ___509_seed_for_orientation.x 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{123} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 250 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp92.x $const18 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_random_angles.x $tmp87.x $tmp92.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_random_angles.y $tmp87.y $tmp92.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:221
#   inclination += random_angles.x * isotropy;
	mul		$tmp93 ___505_random_angles.x isotropy 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{221} %argrw{"wrr"}
	add		___505_inclination ___505_inclination $tmp93 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:222
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:226
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:225
#   return vector3(
	point		___509_orientation $tmp97 $tmp100 $tmp101 	%line{225} %argrw{"wrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:242
...
#   return vector3(hash_vector4_to_float(k),
	functioncall	$const38 266 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{103} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:30
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:243
#     vector3 position_in_kernel_space = position - kernel_center;
	sub		___509_position_in_kernel_space ___516_position_in_cell_space ___509_kernel_center 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{243} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:247
#     float weight = hash_vector4_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	functioncall	$const38 285 	%line{247} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:30
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp111 ___509_seed_for_weight.x ___509_seed_for_weight.y ___509_seed_for_weight.z 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{30} %argrw{"wrrr"}
	hashnoise	$tmp110 $tmp111 ___509_seed_for_weight.w 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:247
#     float weight = hash_vector4_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	lt		$tmp112 $tmp110 $const20 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{247} %argrw{"wrr"}
	if		$tmp112 288 289 	%argrw{"r"}
	assign		___509_weight $const21 	%argrw{"wr"}
	assign		___509_weight $const1 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:249
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:174
#   float distance_squared = dot(position, position);
	dot		___502_distance_squared ___509_position_in_kernel_space ___509_position_in_kernel_space 	%line{174} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:175
#   if (distance_squared >= 1.0) {
	ge		$tmp115 ___502_distance_squared $const1 	%line{175} %argrw{"wrr"}
	if		$tmp115 296 296 	%argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:176
#     return vector2(0.0, 0.0);
	assign		$tmp114.x $const2 	%line{176} %argrw{"wr"}
	assign		$tmp114.y $const2 	%argrw{"wr"}
	return
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:179
#   float hann_window = 0.5 + 0.5 * cos(M_PI * distance_squared);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:180
#   float gaussian_envelop = exp(-M_PI * distance_squared);
	mul		$tmp119 $const24 ___502_distance_squared 	%line{180} %argrw{"wrr"}
	exp		___502_gaussian_envelop $tmp119 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:181
#   float windowed_gaussian_envelope = gaussian_envelop * hann_window;
	mul		___502_windowed_gaussian_envelope ___502_gaussian_envelop ___502_hann_window 	%line{181} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:183
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:184
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:185
#   vector2 phasor = vector2(cos(angle), sin(angle));
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp121.x ___502_windowed_gaussian_envelope 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp121.y ___502_windowed_gaussian_envelope 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 314 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp114.x ___502_phasor.x $tmp121.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp114.y ___502_phasor.y $tmp121.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const25 320 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp122.x ___509_weight 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp113.x $tmp114.x $tmp122.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp113.y $tmp114.y $tmp122.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:332
# 
	functioncall	$const12 323 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{332} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___507_noise.x ___507_noise.x $tmp113.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___507_noise.y ___507_noise.y $tmp113.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:234
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
	add		___508_i ___508_i $const7 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{234} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:251
#   return noise;
...
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___510_sum.x ___510_sum.x $tmp67.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___510_sum.y ___510_sum.y $tmp67.y 	%argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:266
#       for (int i = -1; i <= 1; i++) {
	assign		$tmp123 ___515_i 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{266} %argrw{"wr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:276
#   return sum;
	assign		phasor.x ___510_sum.x 	%line{276} %argrw{"wr"}
	assign		phasor.y ___510_sum.y 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:311
#     standard_deviation = compute_3d_gabor_standard_deviation(frequency);
	functioncall	$const41 349 	%line{311} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:195
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:196
#                                     pow(2.0, 5.0 / 2.0);
	pow		$tmp130 $const42 $const43 	%line{196} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:195
#   float integral_of_gabor_squared = (1.0 - exp(-2.0 * M_PI * frequency * frequency)) /
	div		___504_integral_of_gabor_squared $tmp129 $tmp130 	%line{195} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:197
#   float second_moment = 0.5;
	assign		___504_second_moment $const20 	%line{197} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:198
#   return sqrt(IMPULSES_COUNT * second_moment * integral_of_gabor_squared);
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:314
#     error("Unknown type!");
	error		$const44 	%line{314} %argrw{"r"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:319
#   float normalization_factor = 6.0 * standard_deviation;
	mul		normalization_factor $const45 standard_deviation 	%line{319} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:323
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:327
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:330
#   Intensity = length(phasor) / normalization_factor;
	functioncall	$const35 363 	%line{330} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:192
#     return hypot (a.x, a.y);
	functioncall	$const36 363 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{192} %argrw{"r"}
# D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:101
# float hypot (float a, float b) { return sqrt (a*a + b*b); }
	mul		$tmp138 phasor.x phasor.x 	%filename{"D:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{101} %argrw{"wrr"}
	mul		$tmp139 phasor.y phasor.y 	%argrw{"wrr"}
	add		$tmp140 $tmp138 $tmp139 	%argrw{"wrr"}
	sqrt		$tmp137 $tmp140 	%argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:330
#   Intensity = length(phasor) / normalization_factor;
	div		Intensity $tmp137 normalization_factor 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{330} %argrw{"wrr"}
	end
