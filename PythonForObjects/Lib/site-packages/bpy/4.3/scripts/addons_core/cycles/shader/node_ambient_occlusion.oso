...
# options: -q -O2 -ID:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders -ID:/Blender/blender-git/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/Blender/blender-git/build_windows_Bpy_x64_vc17_Release/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.oso
...
code Normal
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:10
#                               normal Normal = N,
	assign		Normal N 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl"} %line{10} %argrw{"wr"}
code ___main___
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:16
#   int global_radius = (Distance == 0.0 && !isconnected(Distance));
	eq		$tmp1 Distance $const1 	%filename{"D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl"} %line{16} %argrw{"wrr"}
...
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:19
#   AO = texture("@ao",
	assign		$tmp6 samples 	%line{19} %argrw{"wr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:22
#                Normal[0],
	compref		$tmp7 Normal $const2 	%line{22} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:23
#                Normal[1],
	compref		$tmp8 Normal $const4 	%line{23} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:24
#                Normal[2],
	compref		$tmp9 Normal $const5 	%line{24} %argrw{"wrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:19
#   AO = texture("@ao",
	assign		$tmp10 inside 	%line{19} %argrw{"wr"}
	texture		AO $const3 $tmp6 Distance $tmp7 $tmp8 $tmp9 $tmp10 $const6 only_local $const7 global_radius 	%argrw{"wrrrrrrrrrrr"}
# D:/Blender/blender-git/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:30
#   ColorOut = ColorIn * AO;
	mul		ColorOut ColorIn AO 	%line{30} %argrw{"wrr"}
	end
